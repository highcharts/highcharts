...
```
See it [live on jsFiddle](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/amd/simple/).

When using AMD modules, Highcharts also allows mixing [multiple versions in the
same page](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/version-mix/).
