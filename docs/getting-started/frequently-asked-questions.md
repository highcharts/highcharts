...
*   [Using flags in Highcharts](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/stock/series-flags/in-highcharts/)

*   [Enabling a scrollbar in Highcharts](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//in-highcharts/)

*   [Gap size in Highcharts](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/ns/gapsize-in-highcharts/)
...
1.  Use our hack for [exporting multiple charts](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/rting/multiple-charts/). Basically, this code gets the SVG of all charts, modifies it and applies it to one single SVG file that is sent to the server for image conversion. We also support using our client side exporting module, if sending data to our server is a concern. See [this demo](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/exphighcharts/tree/main/ffline/) for an example of this approach.
...
To add data points with irregular intervals, instead of defining `pointStart` and `pointInterval` for the series, define an X value (date) for each point. See [demo of irregular time](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//spline-irregular-time).
