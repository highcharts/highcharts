...
without any bundling tools by using `<script type="module">` ([demo](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/esm/simple/)):
```html
<script type="module">
...
```
View it live on jsFiddle in our [async loading demo](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/async-await/);
