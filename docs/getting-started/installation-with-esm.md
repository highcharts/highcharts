...
without any bundling tools by using `<script type="module">` ([demo](https://highcharts.com/samples/highcharts/esm/simple/)):
```html
<script type="module">
...
```
View it live on jsFiddle in our [async loading demo](https://highcharts.com/samples/highcharts/esm/async-await/);
