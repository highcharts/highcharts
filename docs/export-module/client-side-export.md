...
[View it live on jsFiddle](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/exporting/offline-download-demo/).
...
```
[View it live on jsFiddle](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/rting/offline-download-pdffont/)
