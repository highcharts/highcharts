...
| SVG w/images (CORS enabled server)      | OK              | OK               | OK            | Fallback        | Fallback to export server | Fallback to export server | OK               | Fallback to export server | OK                 | Fallback to export server | Fallback to export server |
