...
[Try it live](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/chart/events-load-class/)
...
[Try it live](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/es/wrap-drawgraph/)

When loading ES modules, one can [access modules directly](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/extending-members/) for further modifications.
...
That was all, the whole [sample can be viewed in jsFiddle](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/tip/trackball-plugin/).
