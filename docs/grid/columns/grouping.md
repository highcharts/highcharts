...
All general header configuration described in the [article on column headers](https://www.highcharts.com/docs/grid/columns/header), including formatting, classes, accessibility options, and precedence rules, also applies when using grouped columns.
