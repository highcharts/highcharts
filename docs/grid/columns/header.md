...
If you need more advanced formatting that is not supported through templating, use the `formatter` callback function instead. As in Highcharts Core, we recommend `format` when possible. [Read more here...](https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting#formatter-callbacks)
