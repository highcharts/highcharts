...
The KPI Component allows user to sync the component with other components in dashboards. You can find more information about it in the [sync chapter](https://www.highcharts.com/docs/dashboards/synchronize-components).
