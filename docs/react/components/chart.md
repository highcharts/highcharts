...
| height           | `number` \| `string` | `null` | Explicit chart height in pixels or as a percentage string (for example `"56%"` of chart width). Maps to [chart.height](https://api.highcharts.com/highcharts/chart.height). |
| width            | `number` \| `string` | `null` | Chart width shortcut. Maps to [chart.width](https://api.highcharts.com/highcharts/chart.width).  |
...
| backgroundColor  | `string`   | `null`            | Chart background color. Maps to [chart.backgroundColor](https://api.highcharts.com/highcharts/chart.backgroundColor). |
