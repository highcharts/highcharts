...
See the online example of a [linear gradient chart background](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/t/backgroundcolor-gradient).
