...
An alternative way to define the SVG structure is to add it to a second SVG in the same HTML document. This is the fastest way of reusing definitions by copy-pasting from online SVG examples. [View sample](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/css/gradient-island/).
...
1.  [Gradients](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/gradient/). The sample shows two gradients. Stop colors are also defined from the CSS.
2.  [Shadows and glows](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/shadow/). The sample shows how to apply an SVG filter. For a simple drop shadow, the built-in `#drop-shadow` filter can be used.
3.  [Patterns](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/pattern/). The sample shows how to add pattern patterns in the defs, and add colors and apply them in CSS. 
4.  [Borrow definitions](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/gradient-island/) from another SVG in the page.
