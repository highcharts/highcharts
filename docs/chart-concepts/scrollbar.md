...
*   [Scrollable bar chart](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/stock/yaxis/inverted-bar-scrollbar/)
*   [Heatmap with two scrollable axes (zoom in first)](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/tmap-scrollbars/)
*   [Scrollable Y axis on stock chart (zoom in first)](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/ollbar/)
