...
See it [live on jsFiddle](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/drilldown/basic/).
...
See the [async drilldown](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/ldown/async/) demo.
