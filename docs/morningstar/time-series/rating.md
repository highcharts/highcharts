...
The Morningstar Rating, also referred to as the star rating, is a quantitative
measurement of a fund's past performance on a scale of 1 to 5. The rating is
assigned within each Morningstar Category based on risk-adjusted returns. Star
ratings are calculated and assigned at the end of every month.
...
In order to fetch Morningstar rating time series, specify series type `Rating`
