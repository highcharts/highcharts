...
map: topology
```
Alternatively, you can apply different maps for different series ([view demo](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/maps/series/affectsmapview/)):
```js
series: [{
    mapData: topology,
    ...
