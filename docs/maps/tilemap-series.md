...
Click [here](https://highcharts.com/samples/maps/plotoptions/honeycomb-brazil/) to check the code.
...
Click [here](https://highcharts.com/samples/maps/demo/circlemap-africa/) to check the code.
...
Click [here](https://highcharts.com/samples/maps/demo/diamondmap/) to check the code.
...
Click [here](https://highcharts.com/samples/maps/series/tilemap-gridoffset) to check the code.
...
Click [here](https://highcharts.com/samples/highcharts/demo/honeycomb-usa/) to check the code.
...
Click [here](https://highcharts.com/samples/maps/plotoptions/tilemap-pointpadding/) to check the code.
