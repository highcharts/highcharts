...
View a live sample of [data fetched from a table](https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/main/samples/highcharts/demo/column-parsed/).
