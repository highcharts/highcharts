...
module.exports = {
    ...
    redirects: [
        ...
        { from: 'grid/data-loading-patterns', to: 'grid/data-handling/overview' },
        { from: 'grid/data-providers', to: 'grid/data-handling/overview' },
        { from: 'grid/theming/theming', to: 'grid/theming/index' },
        { from: 'grid/theming/theming-variables', to: 'grid/theming/grid-variables' },
        { from: 'grid/theming/variables', to: 'grid/theming/grid-variables' },
