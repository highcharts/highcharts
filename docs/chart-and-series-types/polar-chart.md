...
*   [A polar chart with different series types](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/blog/polar-chart)
*   [A spider web](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//polar-spider)