...
Click [here](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/demo/bellcurve/) to check the code.
...
Click [here](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/options/bellcurve-intervals-pointsininterval) to check the code.
