...
See an [example](https://highcharts.com/samples/highcharts/plotoptions/treemap-layoutalgorithm-sliceanddice/) of Slice And Dice.
...
See an [example](https://highcharts.com/samples/highcharts/plotoptions/treemap-layoutalgorithm-stripes/) of Stripes.
...
See an [example](https://highcharts.com/samples/highcharts/plotoptions/treemap-layoutalgorithm-squarified/) of Squarified.
...
See an [example](https://highcharts.com/samples/highcharts/plotoptions/treemap-layoutalgorithm-strip/) of Strip.
...
An [example](https://highcharts.com/samples/highcharts/demo/treemap-large-dataset) where levelIsConstant is set to false.
...
[Full example is found here](https://highcharts.com/samples/highcharts/demo/treemap-coloraxis)
...
[Full example is found here](https://highcharts.com/samples/highcharts/plotoptions/treemap-grouping-advanced)
...
*   [Treemap with colorAxis](https://highcharts.com/samples/highcharts/demo/treemap-coloraxis)
*   [Treemap displaying the global mortality rate and causes](https://highcharts.com/samples/highcharts/demo/treemap-large-dataset)
*   [Treemap using level specific options](https://highcharts.com/samples/highcharts/demo/treemap-with-levels)
