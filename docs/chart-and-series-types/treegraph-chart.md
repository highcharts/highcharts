...
*   [Phylogenetic Treegraph](https://highcharts.com/samples/highcharts/demo/treegraph-chart)
*   [Treegraph chart with different link types](https://highcharts.com/samples/highcharts/series-treegraph/link-types)
*   [Treegraph chart with text path on dataLabels for links](https://highcharts.com/samples/highcharts/series-treegraph/link-text-path)
*   [Treegraph chart with different node level for nodes](https://highcharts.com/samples/highcharts/series-treegraph/node-level)
*   [Inverted treegraph](https://highcharts.com/samples/highcharts/demo/treegraph-inverted)
