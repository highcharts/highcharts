...
Here is an [example](https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/main/samples/highcharts/blog/packed-bubble-basic) of a packed bubble chart in its simplest form:
