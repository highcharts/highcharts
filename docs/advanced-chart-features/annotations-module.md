...
Click [here](https://highcharts.com/samples/highcharts/demo/annotations/) to check the code.
...
Click [here](https://highcharts.com/samples/highcharts/annotations/mock-point/) to check the code.
...
It is possible to define markers at the end and at the beginning of the path. To apply the markers set `markerEnd` or `markerStart` property to the id of the marker. Check the following example about how to define custom markers [here](https://highcharts.com/samples/highcharts/annotations/custom-markers).
