...
Click [here](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/demo/annotations/) to check the code.
...
Click [here](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/tations/mock-point/) to check the code.
