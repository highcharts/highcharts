...
and see the [addEvent and render demo](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/members/addevent/).
...
Check out the demo for [renderer on a chart](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/ers/renderer-on-chart/).
