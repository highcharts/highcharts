...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var _SVGElement$prototype;

		var SVGElement,
		    SVGRenderer,
		    addEvent = _Globals2.default.addEvent,
		    _animate = _Globals2.default.animate,
		    attr = _Globals2.default.attr,
		    Color = _Globals2.default.Color,
		    _css = _Globals2.default.css,
		    createElement = _Globals2.default.createElement,
		    defined = _Globals2.default.defined,
		    deg2rad = _Globals2.default.deg2rad,
		    destroyObjectProperties = _Globals2.default.destroyObjectProperties,
		    doc = _Globals2.default.doc,
		    each = _Globals2.default.each,
		    extend = _Globals2.default.extend,
		    erase = _Globals2.default.erase,
		    hasTouch = _Globals2.default.hasTouch,
		    isArray = _Globals2.default.isArray,
		    isFirefox = _Globals2.default.isFirefox,
		    isMS = _Globals2.default.isMS,
		    isObject = _Globals2.default.isObject,
		    isString = _Globals2.default.isString,
		    isWebKit = _Globals2.default.isWebKit,
		    merge = _Globals2.default.merge,
		    noop = _Globals2.default.noop,
		    pick = _Globals2.default.pick,
		    pInt = _Globals2.default.pInt,
		    removeEvent = _Globals2.default.removeEvent,
		    stop = _Globals2.default.stop,
		    svg = _Globals2.default.svg,
		    SVG_NS = _Globals2.default.SVG_NS,
		    useCanVG = _Globals2.default.useCanVG,
		    win = _Globals2.default.win;

		/**
	  * A wrapper object for SVG elements
	  */
		SVGElement = _Globals2.default.SVGElement = function () {
			return this;
		};
	   ...
	   */
			init: function init(renderer, nodeName) {
				var wrapper = this;
				wrapper.element = nodeName === 'span' ? createElement(nodeName) : doc.createElementNS(wrapper.SVG_NS, nodeName);
			...
			colorGradient: function colorGradient(color, prop, elem) {
				...
				if (gradName) {
					...
					if (gradients[key]) {
						...
						gradAttr.id = id = 'highcharts-' + _Globals2.default.idCounter++;
	   ...
	   */
			applyTextShadow: function applyTextShadow(textShadow) {
	   ...
	   */
			attr: function attr(hash, val, complete) {
				var key,
				    value,
	   ...
	   * @returns {undefined}
	   */
			updateShadows: function updateShadows(key, value, setter) {
	   ...
	   */
			css: function css(styles) {
				...
				if (hasNew) {
					textWidth = elemWrapper.textWidth = styles && styles.width && elem.nodeName.toLowerCase() === 'text' && pInt(styles.width) || elemWrapper.textWidth; // #3501
	   ...
	   */
		...
		}, _defineProperty(_SVGElement$prototype, 'strokeWidth', function strokeWidth() {
			...
			return ret;
		}), _defineProperty(_SVGElement$prototype, 'on', function on(eventType, handler) {
			var svgElement = this,
			...
			return this;
		}), _defineProperty(_SVGElement$prototype, 'setRadialReference', function setRadialReference(coordinates) {
			...
			return this;
		}), _defineProperty(_SVGElement$prototype, 'translate', function translate(x, y) {
			return this.attr({
				translateX: x,
				translateY: y
			});
		}), _defineProperty(_SVGElement$prototype, 'invert', function invert() {
			var wrapper = this;
			wrapper.inverted = true;
			wrapper.updateTransform();
			return wrapper;
		}), _defineProperty(_SVGElement$prototype, 'updateTransform', function updateTransform() {
			var wrapper = this,
		...
		}), _defineProperty(_SVGElement$prototype, 'toFront', function toFront() {
			var element = this.element;
			element.parentNode.appendChild(element);
			return this;
		}), _defineProperty(_SVGElement$prototype, 'align', function align(alignOptions, alignByTranslate, box) {
			var align,
			    vAlign,
			    x,
			    y,
			...
			return this;
		}), _defineProperty(_SVGElement$prototype, 'getBBox', function getBBox(reload, rot) {
			var wrapper = this,
			    bBox,
			    // = wrapper.bBox,
			...
			return bBox;
		}), _defineProperty(_SVGElement$prototype, 'show', function show(inherit) {
			return this.attr({ visibility: inherit ? 'inherit' : 'visible' });
		}), _defineProperty(_SVGElement$prototype, 'hide', function hide() {
			return this.attr({ visibility: 'hidden' });
		}), _defineProperty(_SVGElement$prototype, 'fadeOut', function fadeOut(duration) {
			var elemWrapper = this;
			elemWrapper.animate({
				opacity: 0
			}, {
		...
		}), _defineProperty(_SVGElement$prototype, 'add', function add(parent) {
			...
			return this;
		}), _defineProperty(_SVGElement$prototype, 'safeRemoveChild', function safeRemoveChild(element) {
			var parentNode = element.parentNode;
			if (parentNode) {
				parentNode.removeChild(element);
			}
		}), _defineProperty(_SVGElement$prototype, 'destroy', function destroy() {
			var wrapper = this,
			    element = wrapper.element || {},
			...
			return null;
		}), _defineProperty(_SVGElement$prototype, 'shadow', function shadow(shadowOptions, group, cutOff) {
			var shadows = [],
			    i,
			    shadow,
			    element = this.element,
			...
			return this;
		}), _defineProperty(_SVGElement$prototype, 'xGetter', function xGetter(key) {
		...
		}), _defineProperty(_SVGElement$prototype, '_defaultGetter', function _defaultGetter(key) {
			...
			return ret;
		}), _defineProperty(_SVGElement$prototype, 'dSetter', function dSetter(value, key, element) {
			if (value && value.join) {
				// join path
				value = value.join(' ');
			}
			...
			this[key] = value;
		}), _defineProperty(_SVGElement$prototype, 'dashstyleSetter', function dashstyleSetter(value) {
			var i;
		...
		}), _defineProperty(_SVGElement$prototype, 'alignSetter', function alignSetter(value) {
			var convert = { left: 'start', center: 'middle', right: 'end' };
			this.element.setAttribute('text-anchor', convert[value]);
		}), _defineProperty(_SVGElement$prototype, 'opacitySetter', function opacitySetter(value, key, element) {
			this[key] = value;
			element.setAttribute(key, value);
		}), _defineProperty(_SVGElement$prototype, 'titleSetter', function titleSetter(value) {
			var titleNode = this.element.getElementsByTagName('title')[0];
			if (!titleNode) {
				titleNode = doc.createElementNS(this.SVG_NS, 'title');
				this.element.appendChild(titleNode);
			}
			titleNode.appendChild(doc.createTextNode(String(pick(value), '').replace(/<[^>]*>/g, '') // #3276, #3895
			));
		}), _defineProperty(_SVGElement$prototype, 'textSetter', function textSetter(value) {
		...
		}), _defineProperty(_SVGElement$prototype, 'fillSetter', function fillSetter(value, key, element) {
			if (typeof value === 'string') {
				element.setAttribute(key, value);
			} else if (value) {
				this.colorGradient(value, key, element);
			}
		}), _defineProperty(_SVGElement$prototype, 'visibilitySetter', function visibilitySetter(value, key, element) {
		...
		}), _defineProperty(_SVGElement$prototype, 'zIndexSetter', function zIndexSetter(value, key) {
			var renderer = this.renderer,
			...
			return inserted;
		}), _defineProperty(_SVGElement$prototype, '_defaultSetter', function _defaultSetter(value, key, element) {
			// if (key === 'width' && isNaN(value)) debugger;
			element.setAttribute(key, value);
		}), _SVGElement$prototype);
	   ...
	   */
			buildText: function buildText(wrapper) {
				var textNode = wrapper.element,
					...
					var fontSizeStyle;
					/*= if (build.classic) { =*/
					fontSizeStyle = /(px|em)$/.test(tspan && tspan.style.fontSize) ? tspan.style.fontSize : textStyles && textStyles.fontSize || renderer.style.fontSize || 12;
					/*= } =*/

					return textLineHeight ? pInt(textLineHeight) : renderer.fontMetrics(fontSizeStyle, tspan).h;
				},
				    unescapeAngleBrackets = function unescapeAngleBrackets(inputStr) {
	  ...
	  */
	   ...
	   */
			symbol: function symbol(_symbol, x, y, width, height, options) {
				...
				path = defined(x) && symbolFn && symbolFn(Math.round(x), Math.round(y), width, height, options),
				    imageRegex = /^url\((.*?)\)$/,
				    imageSrc,
				    centerImage,
				    symbolSizes = {};
	   ...
	   */
			clipRect: function clipRect(x, y, width, height) {
				var wrapper,
				    id = 'highcharts-' + _Globals2.default.idCounter++,
	    ...
	    */
				updateBoxSize = function updateBoxSize() {
					...
					if (needsBox) {
						...
						if (!box) {
							wrapper.box = box = shape ? renderer.symbol(shape) : renderer.rect();
							if (className) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var attr = _Globals2.default.attr,
		    charts = _Globals2.default.charts,
		    doc = _Globals2.default.doc,
		    win = _Globals2.default.win;
	  ...
	  */
		_Globals2.default.Fx = function (elem, options, prop) {
			this.options = options;
			this.elem = elem;
			this.prop = prop;
		};
		_Globals2.default.Fx.prototype = {
			...
			dSetter: function dSetter() {
				...
				if (now === 1) {
					...
					while (i--) {
						...
						start[i] : now * parseFloat(end[i] - startVal) + startVal;
					}
				} else {
	  ...
	  */
		_Globals2.default.extend = function (a, b) {
			var n;
			if (!a) {
				a = {};
			}
	  ...
	  */
		_Globals2.default.merge = function () {
			var i,
			    args = arguments,
			    len,
			    ret = {},
				...
				for (key in original) {
					if (original.hasOwnProperty(key)) {
						...
						if (value && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && Object.prototype.toString.call(value) !== '[object Array]' && key !== 'renderTo' && typeof value.nodeType !== 'number') {
	  ...
	  */
		_Globals2.default.pInt = function (s, mag) {
	  ...
	  * @param {Object} s
	  */
		_Globals2.default.isString = function (s) {
	  ...
	  * @param {Object} obj
	  */
		_Globals2.default.isObject = function (obj) {
	  ...
	  * @param {Object} obj
	  */
		_Globals2.default.isArray = function (obj) {
	  ...
	  * @param {Object} n
	  */
		_Globals2.default.isNumber = function (n) {
			return typeof n === 'number';
		};

		_Globals2.default.log2lin = function (num) {
			return Math.log(num) / Math.LN10;
		};
		_Globals2.default.lin2log = function (num) {
	  ...
	  * @param {Mixed} item
	  */
		_Globals2.default.erase = function (arr, item) {
			var i = arr.length;
			while (i--) {
				if (arr[i] === item) {
					arr.splice(i, 1);
	  ...
	  * @param {Object} obj
	  */
		_Globals2.default.defined = function (obj) {
	  ...
	  */
		_Globals2.default.attr = function (elem, prop, value) {
			var key, ret;

			// if the prop is a string
			if (_Globals2.default.isString(prop)) {
				// set the value
				if (_Globals2.default.defined(value)) {
					elem.setAttribute(prop, value);
			...
			} else if (_Globals2.default.defined(prop) && _Globals2.default.isObject(prop)) {
					for (key in prop) {
	  ...
	  */
		_Globals2.default.splat = function (obj) {
			return _Globals2.default.isArray(obj) ? obj : [obj];
		};
	  ...
	  */
		_Globals2.default.syncTimeout = function (fn, delay, context) {
			if (delay) {
	  ...
	  */
		_Globals2.default.pick = function () {
			var args = arguments,
			    i,
			    arg,
			    length = args.length;
	  ...
	  */
		_Globals2.default.css = function (el, styles) {
			if (_Globals2.default.isMS && !_Globals2.default.svg) {
				// #2686
				if (styles && styles.opacity !== undefined) {
					styles.filter = 'alpha(opacity=' + styles.opacity * 100 + ')';
				}
			}
			_Globals2.default.extend(el.style, styles);
		};
	  ...
	  * @param {Object} nopad
	  */
		_Globals2.default.createElement = function (tag, attribs, styles, parent, nopad) {
			var el = doc.createElement(tag),
			    css = _Globals2.default.css;
			if (attribs) {
				_Globals2.default.extend(el, attribs);
			}
			if (nopad) {
	  ...
	  */
		_Globals2.default.extendClass = function (Parent, members) {
			var object = function object() {};
			object.prototype = new Parent();
			_Globals2.default.extend(object.prototype, members);
			return object;
		};
	  ...
	  * @param {Number} length
	  */
		_Globals2.default.pad = function (number, length) {
	  ...
	  */
		_Globals2.default.relativeLength = function (value, base) {
	  ...
	  * argument.
	  */
		_Globals2.default.wrap = function (obj, method, func) {
		...
		_Globals2.default.getTZOffset = function (timestamp) {
			var d = _Globals2.default.Date;
	  ...
	  */
		_Globals2.default.dateFormat = function (format, timestamp, capitalize) {
			if (!_Globals2.default.defined(timestamp) || isNaN(timestamp)) {
				return _Globals2.default.defaultOptions.lang.invalidDate || '';
			}
			format = _Globals2.default.pick(format, '%Y-%m-%d %H:%M:%S');

			var d = _Globals2.default.Date,
			    date = new d(timestamp - _Globals2.default.getTZOffset(timestamp)),
			    key,
			...
			hours = date[d.hcGetHours](),
			    ...
			    lang = _Globals2.default.defaultOptions.lang,
			    langWeekdays = lang.weekdays,
			    pad = _Globals2.default.pad,


			// List all format keys. Custom formats can be added from the outside.
			replacements = _Globals2.default.extend({
	  ...
	  */
		_Globals2.default.formatSingle = function (format, val) {
			var floatRegex = /f$/,
			    decRegex = /\.([0-9])/,
			    lang = _Globals2.default.defaultOptions.lang,
			    decimals;
			...
			if (floatRegex.test(format)) {
				...
				if (val !== null) {
					val = _Globals2.default.numberFormat(val, decimals, lang.decimalPoint, format.indexOf(',') > -1 ? lang.thousandsSep : '');
				}
			} else {
				val = _Globals2.default.dateFormat(format, val);
			}
			return val;
		};
	  ...
	  */
		_Globals2.default.format = function (str, ctx) {
			var splitter = '{',
			    isInside = false,
			    segment,
			    valueAndFormat,
			...
			while (str) {
				...
				if (isInside) {
					...
					if (valueAndFormat.length) {
						val = _Globals2.default.formatSingle(valueAndFormat.join(':'), val);
					}
	  ...
	  */
		_Globals2.default.getMagnitude = function (num) {
	  ...
	  * @param {Object} options
	  */
		_Globals2.default.normalizeTickInterval = function (interval, multiples, magnitude, allowDecimals, preventExceed) {
			var normalized,
			    i,
			    retInterval = interval;

			// round to a tenfold of 1, 2, 2.5 or 5
			magnitude = _Globals2.default.pick(magnitude, 1);
	  ...
	  */
		_Globals2.default.stableSort = function (arr, sortFunction) {
	  ...
	  */
		_Globals2.default.arrayMin = function (data) {
			var i = data.length,
			    min = data[0];
	  ...
	  * method is slightly slower, but safe.
	  */
		_Globals2.default.arrayMax = function (data) {
			var i = data.length,
			    max = data[0];
	  ...
	  */
		_Globals2.default.destroyObjectProperties = function (obj, except) {
			var n;
			for (n in obj) {
	  ...
	  */
		_Globals2.default.discardElement = function (element) {
			var garbageBin = _Globals2.default.garbageBin;
			// create a garbage bin element, not part of the DOM
			if (!garbageBin) {
				garbageBin = _Globals2.default.createElement('div');
			}
	  ...
	  * @param {Number} num
	  */
		_Globals2.default.correctFloat = function (num, prec) {
	  ...
	  * @param {Object} chart
	  */
		_Globals2.default.setAnimation = function (animation, chart) {
			chart.renderer.globalAnimation = _Globals2.default.pick(animation, chart.animation);
		};

		/**
	  * The time unit lookup
	  */
		_Globals2.default.timeUnits = {
			millisecond: 1,
			second: 1000,
			minute: 60000,
			hour: 3600000,
	  ...
	  */
		_Globals2.default.numberFormat = function (number, decimals, decimalPoint, thousandsSep) {
			...
			strinteger = String(_Globals2.default.pInt(absNumber.toFixed(decimals)));

			// Leftover after grouping into thousands. Can be 0, 1 or 3.
			thousands = strinteger.length > 3 ? strinteger.length % 3 : 0;

			// Language
			decimalPoint = _Globals2.default.pick(decimalPoint, lang.decimalPoint);
			thousandsSep = _Globals2.default.pick(thousandsSep, lang.thousandsSep);
	  ...
	  */
		_Globals2.default.getStyle = function (el, prop) {

			var style;

			// For width and height, return the actual inner pixel size (#4913)
			if (prop === 'width') {
				return el.scrollWidth - _Globals2.default.getStyle(el, 'padding-left') - _Globals2.default.getStyle(el, 'padding-right');
			} else if (prop === 'height') {
				return el.scrollHeight - _Globals2.default.getStyle(el, 'padding-top') - _Globals2.default.getStyle(el, 'padding-bottom');
			}

			// Otherwise, get the computed style
			style = win.getComputedStyle(el, undefined);
			return style && _Globals2.default.pInt(style.getPropertyValue(prop));
		};

		/**
	  * Return the index of an item in an array, or -1 if not found
	  */
		_Globals2.default.inArray = function (item, arr) {
	  ...
	  * Filter an array
	  */
		_Globals2.default.grep = function (elements, callback) {
	  ...
	  * Map an array
	  */
		_Globals2.default.map = function (arr, fn) {
			var results = [],
			    i = 0,
			    len = arr.length;
	  ...
	  */
		_Globals2.default.offset = function (el) {
	  ...
	  */
		_Globals2.default.stop = function (el) {
	  ...
	  * @param {Function} fn
	  */
		_Globals2.default.each = function (arr, fn, ctx) {
			// modern browsers
	  ...
	  */
		_Globals2.default.addEvent = function (el, type, fn) {
	  ...
	  */
		_Globals2.default.removeEvent = function (el, type, fn) {
			...
			if (hcEvents) {
				if (type) {
					...
					if (fn) {
						index = _Globals2.default.inArray(fn, events);
						if (index > -1) {
	  ...
	  */
		_Globals2.default.fireEvent = function (el, type, eventArguments, defaultFunction) {
			var e,
			    hcEvents = el.hcEvents,
			    events,
			    len,
			...
			if (doc.createEvent && (el.dispatchEvent || el.fireEvent)) {
				...
				_Globals2.default.extend(e, eventArguments);
	  ...
	  */
		_Globals2.default.animate = function (el, params, opt) {
			var start,
			    unit = '',
			    end,
			    fx,
			...
			if (!_Globals2.default.isObject(opt)) {
			...
			if (!_Globals2.default.isNumber(opt.duration)) {
				opt.duration = 400;
			}
			opt.easing = Math[opt.easing] || Math.easeInOutSine;
			opt.curAnim = _Globals2.default.merge(params);

			for (prop in params) {
				fx = new _Globals2.default.Fx(el, opt, prop);
				end = null;
				...
				if (prop === 'd') {
					...
					start = parseFloat(_Globals2.default.getStyle(el, prop)) || 0;
					if (prop !== 'opacity') {
						unit = 'px';
					}
				}
			...
			win.jQuery.fn.highcharts = function () {
				...
				if (this[0]) {
					...
					if (args[0]) {
						...
						_Globals2.default.isString(args[0]) ? args.shift() : 'Chart' // Constructor defaults to Chart
						](this[0], args[0], args[1]);
						return this;
					}

					// When called without parameters or with the return argument, return an existing chart
					return charts[_Globals2.default.attr(this[0], 'data-highcharts-chart')];
				}
			};
		}
	  ...
	  */
		if (doc && !doc.defaultView) {
			_Globals2.default.getStyle = function (el, prop) {
				...
				if (el.style[prop]) {
					return _Globals2.default.pInt(el.style[prop]);
				}
				if (prop === 'opacity') {
					prop = 'filter';
				}
				...
				if (alias) {
					el.style.zoom = 1;
					return el[alias] - 2 * _Globals2.default.getStyle(el, 'padding');
				}
				...
				return val === '' ? 1 : _Globals2.default.pInt(val);
			};
		}
		...
		if (!Array.prototype.filter) {
			_Globals2.default.grep = function (elements, fn) {
				var ret = [],
				    i = 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var each = _Globals2.default.each,
		    isNumber = _Globals2.default.isNumber,
		    map = _Globals2.default.map,
		    merge = _Globals2.default.merge,
		    pInt = _Globals2.default.pInt;
		/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var attr = _Globals2.default.attr,
		    ...
		    pick = _Globals2.default.pick,
		    pInt = _Globals2.default.pInt,
		    SVGElement = _Globals2.default.SVGElement,
		    SVGRenderer = _Globals2.default.SVGRenderer,
		    win = _Globals2.default.win,
	   ...
	   */
			html: function html(str, x, y) {
				var wrapper = this.createElement('span'),
				    element = wrapper.element,
				    renderer = wrapper.renderer,
				    addSetters = function addSetters(element, style) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var VMLRenderer,
		    ...
		    createElement = _Globals2.default.createElement,
		    css = _Globals2.default.css,
		    defaultOptions = _Globals2.default.defaultOptions,
		    defined = _Globals2.default.defined,
		    deg2rad = _Globals2.default.deg2rad,
		    discardElement = _Globals2.default.discardElement,
		    doc = _Globals2.default.doc,
		    each = _Globals2.default.each,
		    erase = _Globals2.default.erase,
		    extend = _Globals2.default.extend,
		    extendClass = _Globals2.default.extendClass,
		    isArray = _Globals2.default.isArray,
		    isNumber = _Globals2.default.isNumber,
		    isObject = _Globals2.default.isObject,
		    merge = _Globals2.default.merge,
	  ...
	  */
	   ...
	   */
	    ...
	    */
				...
				'fill-opacitySetter': function fillOpacitySetter(value, key, element) {
	      ...
	      value = Math.max(0, value); // don't set width or height below zero (#311)
			...
			_Globals2.default.VMLElement = VMLElement = extendClass(SVGElement, VMLElement);
	   ...
	   */
	    ...
	    */
	     ...
	     */
			...
			_Globals2.default.VMLRenderer = VMLRenderer = function VMLRenderer() {
				this.init.apply(this, arguments);
			};
			VMLRenderer.prototype = merge(SVGRenderer.prototype, VMLRendererExtension);

			// general renderer
			_Globals2.default.Renderer = VMLRenderer;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  */
	   ...
	   */
			_Globals2.default.Renderer = CanVGRenderer = function CanVGRenderer() {
				// Override the global SVG namespace to fake SVG/HTML that accepts CSS
				_Globals2.default.SVG_NS = 'http://www.w3.org/1999/xhtml';
			};
	   ...
	   */
			_Globals2.default.CanVGController = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var addEvent = _Globals2.default.addEvent,
		    arrayMax = _Globals2.default.arrayMax,
		    arrayMin = _Globals2.default.arrayMin,
		    AxisPlotLineOrBandExtension = _Globals2.default.AxisPlotLineOrBandExtension,
		    correctFloat = _Globals2.default.correctFloat,
		    defaultOptions = _Globals2.default.defaultOptions,
		    defaultPlotOptions = _Globals2.default.defaultPlotOptions,
		    defined = _Globals2.default.defined,
		    deg2rad = _Globals2.default.deg2rad,
		    destroyObjectProperties = _Globals2.default.destroyObjectProperties,
		    each = _Globals2.default.each,
		    error = _Globals2.default.error,
		    extend = _Globals2.default.extend,
		    fireEvent = _Globals2.default.fireEvent,
		    format = _Globals2.default.format,
		    getMagnitude = _Globals2.default.getMagnitude,
		    inArray = _Globals2.default.inArray,
		    isNumber = _Globals2.default.isNumber,
		    isString = _Globals2.default.isString,
		    lin2log = _Globals2.default.lin2log,
		    log2lin = _Globals2.default.log2lin,
		    merge = _Globals2.default.merge,
		    normalizeTickInterval = _Globals2.default.normalizeTickInterval,
		    pick = _Globals2.default.pick,
		    PlotLineOrBand = _Globals2.default.PlotLineOrBand,
		    removeEvent = _Globals2.default.removeEvent,
		    splat = _Globals2.default.splat,
		    syncTimeout = _Globals2.default.syncTimeout,
		    Tick = _Globals2.default.Tick;
		/**
	  * Create a new axis object
	  * @param {Object} chart
	  * @param {Object} options
	  */
		_Globals2.default.Axis = function () {
			this.init.apply(this, arguments);
		};

		_Globals2.default.Axis.prototype = {
			...
			defaultYAxisOptions: {
				...
				stackLabels: {
					...
					formatter: function formatter() {
						return _Globals2.default.numberFormat(this.total, -1);
					},
	   ...
	   */
			defaultLabelFormatter: function defaultLabelFormatter() {
				...
				if (formatOption) {
					...
					// datetime axis
					ret = _Globals2.default.dateFormat(dateTimeLabelFormat, value);
					...
					while (i-- && ret === undefined) {
						...
						if (numericSymbolDetector >= multi && value * 10 % multi === 0 && numericSymbols[i] !== null) {
							ret = _Globals2.default.numberFormat(value / multi, -1) + numericSymbols[i];
						}
					}
				}
				...
				if (ret === undefined) {
					if (Math.abs(value) >= 10000) {
						...
						ret = _Globals2.default.numberFormat(value, -1);
					} else {
						// small numbers
						ret = _Globals2.default.numberFormat(value, -1, undefined, ''); // #2466
					}
				}
					...
					if (linkedParent) {
						...
						each(axis.series, function (series) {
							...
							if (!series.noSharedTooltip && defined(seriesClosest)) {
								closestPointRange = defined(closestPointRange) ? Math.min(closestPointRange, seriesClosest) : seriesClosest;
							}
						});
	   ...
	   */
			setTickInterval: function setTickInterval(secondPass) {
				...
				if (axis.min === axis.max || axis.min === undefined || axis.max === undefined) {
					...
					axis.tickInterval = pick(tickIntervalOption, this.tickAmount ? (axis.max - axis.min) / Math.max(this.tickAmount - 1, 1) : undefined, categories ? // for categoried axis, 1 is default, for linear axis use tickPix
					1 :
	   ...
	   */
			adjustTickAmount: function adjustTickAmount() {
				...
				if (defined(finalTickAmt)) {
					...
					while (i--) {
						if (finalTickAmt === 3 && i % 2 === 1 || // Remove every other tick
	   ...
	   */
			...
			renderUnsquish: function renderUnsquish() {
				...
				(this.staggerLines || 1) * chart.plotWidth / slotCount || !horiz && (margin[3] && margin[3] - chart.spacing[3] || chart.chartWidth * 0.33),
				    // #1580, #1931,
						...
						if (!textOverflowOption) {
							...
							while (!horiz && i--) {
								...
								if (label) {
									...
									if (label.getBBox().height > this.len / tickPositions.length - (labelMetrics.h - labelMetrics.f) || ticks[pos].labelLength > slotWidth) {
										// #4678
	   ...
	   */
			getOffset: function getOffset() {
				...
				if (!axis.axisGroup) {
					axis.gridGroup = renderer.g('grid').attr({ zIndex: options.gridZIndex || 1 }).addClass('highcharts-' + this.coll.toLowerCase() + '-grid ' + (className || '')) // docs: className
					.add(axisParent);
					axis.axisGroup = renderer.g('axis').attr({ zIndex: options.zIndex || 2 }).addClass('highcharts-' + this.coll.toLowerCase() + ' ' + (className || '')) // docs: className
					.add(axisParent);
				...
				labelOffsetPadded = Math.abs(labelOffset) + titleMargin + (labelOffset && directionFactor * (horiz ? pick(labelOptions.y, axis.tickRotCorr.y + 8) : labelOptions.x) - lineHeightCorrection);
	   ...
	   */
		...
		extend(_Globals2.default.Axis.prototype, AxisPlotLineOrBandExtension);
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var each = _Globals2.default.each,
		    getTZOffset = _Globals2.default.getTZOffset,
		    isTouchDevice = _Globals2.default.isTouchDevice,
		    merge = _Globals2.default.merge,
		    pick = _Globals2.default.pick,
		    svg = _Globals2.default.svg,
		    win = _Globals2.default.win;
	  ...
	  * Handle the options                                                         *
	  *****************************************************************************/
		_Globals2.default.defaultOptions = {
			/*= if (build.classic) { =*/
			...
			plotOptions: {
				line: { // base series options
					...
					dataLabels: {
						...
						// enabled: false,
						formatter: function formatter() {
							return this.y === null ? '' : _Globals2.default.numberFormat(this.y, -1);
						},
						/*= if (!build.classic) { =*/
						/*style: {
	     	color: 'contrast',
	   ...
	   */
				...
				borderWidth: 1
			}, _defineProperty(_tooltip, 'headerFormat', '<span style="font-size: 10px">{point.key}</span><br/>'), _defineProperty(_tooltip, 'pointFormat', '<span style="color:{point.color}">●</span> {series.name}: <b>{point.y}</b><br/>'), _defineProperty(_tooltip, 'shadow', true), _defineProperty(_tooltip, 'style', {
				color: '#333333',
				cursor: 'default',
				fontSize: '12px',
	  ...
	  */
		function setTimeMethods() {
			var globalOptions = _Globals2.default.defaultOptions.global,
			    Date,
			    useUTC = globalOptions.useUTC,
			    GET = useUTC ? 'getUTC' : 'get',
			    SET = useUTC ? 'setUTC' : 'set';

			_Globals2.default.Date = Date = globalOptions.Date || win.Date; // Allow using a different Date class
	  ...
	  */
		_Globals2.default.setOptions = function (options) {

			// Copy in the default options
			_Globals2.default.defaultOptions = merge(true, _Globals2.default.defaultOptions, options);

			// Apply UTC
			setTimeMethods();

			return _Globals2.default.defaultOptions;
		};
	  ...
	  */
		_Globals2.default.getOptions = function () {
			return _Globals2.default.defaultOptions;
		};

		// Series defaults
		_Globals2.default.defaultPlotOptions = _Globals2.default.defaultOptions.plotOptions;
		_Globals2.default.defaultSeriesOptions = _Globals2.default.defaultPlotOptions.line;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var arrayMax = _Globals2.default.arrayMax,
		    arrayMin = _Globals2.default.arrayMin,
		    defined = _Globals2.default.defined,
		    destroyObjectProperties = _Globals2.default.destroyObjectProperties,
		    each = _Globals2.default.each,
	  ...
	  * @param {Object} options
	  */
		_Globals2.default.PlotLineOrBand = function (axis, options) {
			this.axis = axis;
		...
		_Globals2.default.PlotLineOrBand.prototype = {
	   ...
	   */
			render: function render() {
				...
				if (!group) {
					axis[groupName] = group = renderer.g('plot-' + groupName).attr(groupAttribs).add();
				}
	   ...
	   */
			renderLabel: function renderLabel(optionsLabel, path, isBand, zIndex) {
				var plotLine = this,
				    label = plotLine.label,
	  ...
	  */
		...
		_Globals2.default.AxisPlotLineOrBandExtension = {
	   ...
	   */
			addPlotBandOrLine: function addPlotBandOrLine(options, coll) {
				var obj = new _Globals2.default.PlotLineOrBand(this, options).render(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var correctFloat = _Globals2.default.correctFloat,
		    defined = _Globals2.default.defined,
		    destroyObjectProperties = _Globals2.default.destroyObjectProperties,
		    lin2log = _Globals2.default.lin2log,
		    merge = _Globals2.default.merge,
	  ...
	  * The Tick class
	  */
		_Globals2.default.Tick = function (axis, pos, type, noLabel) {
			this.axis = axis;
			this.pos = pos;
			this.type = type || '';
			this.isNew = true;
		...
		_Globals2.default.Tick.prototype = {
			/**
	   ...
	   */
			getLabelPosition: function getLabelPosition(x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
				...
				if (!defined(yOffset)) {
					yOffset = axis.side === 2 ? rotCorr.y + 8 :
					// #3140, #3140
		...
		Axis.prototype.getTimeTicks = function (normalizedInterval, min, max, startOfWeek) {
			...
			if (defined(min)) {
				...
				if (interval >= timeUnits.minute) {
					// minute
					minDate[Date.hcSetMinutes](interval >= timeUnits.hour ? 0 : count * Math.floor(minDate[Date.hcGetMinutes]() / count));
				}

				if (interval >= timeUnits.hour) {
					// hour
					minDate[Date.hcSetHours](interval >= timeUnits.day ? 0 : count * Math.floor(minDate[Date.hcGetHours]() / count));
				}

				if (interval >= timeUnits.day) {
					// day
					minDate[Date.hcSetDate](interval >= timeUnits.month ? 1 : count * Math.floor(minDate[Date.hcGetDate]() / count));
				}

				if (interval >= timeUnits.month) {
					// month
					minDate[Date.hcSetMonth](interval >= timeUnits.year ? 0 : count * Math.floor(minDate[Date.hcGetMonth]() / count));
				...
				if (interval === timeUnits.week) {
					...
					minDate[Date.hcSetDate](minDate[Date.hcGetDate]() - minDate[Date.hcGetDay]() + pick(startOfWeek, 1));
				}
				...
				var time = minDate.getTime(),
				    ...
				    variableDayLength = !useUTC || !!Date.hcGetTimezoneOffset,
				    // #4951
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var dateFormat = _Globals2.default.dateFormat,
		    each = _Globals2.default.each,
		    extend = _Globals2.default.extend,
		    fireEvent = _Globals2.default.fireEvent,
		    format = _Globals2.default.format,
	  ...
	  */
		_Globals2.default.Tooltip = function () {
			this.init.apply(this, arguments);
		};

		_Globals2.default.Tooltip.prototype = {
	   ...
	   */
			tooltipFooterHeaderFormatter: function tooltipFooterHeaderFormatter(point, isFooter) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var addEvent = _Globals2.default.addEvent,
		    ...
		    extend = _Globals2.default.extend,
		    fireEvent = _Globals2.default.fireEvent,
		    offset = _Globals2.default.offset,
		    pick = _Globals2.default.pick,
		    removeEvent = _Globals2.default.removeEvent,
		    splat = _Globals2.default.splat,
		    Tooltip = _Globals2.default.Tooltip,
		    useCanVG = _Globals2.default.useCanVg,
		    win = _Globals2.default.win;

		// Global flag for touch support
		_Globals2.default.hasTouch = doc && doc.documentElement.ontouchstart !== undefined;
	  ...
	  */
		_Globals2.default.Pointer = function (chart, options) {
			this.init(chart, options);
		};

		_Globals2.default.Pointer.prototype = {
			/**
	   * Initialize Pointer
	   */
			init: function init(chart, options) {
			...
			runPointActions: function runPointActions(e) {
				...
				if (!pointer._onDocumentMouseMove) {
					pointer._onDocumentMouseMove = function (e) {
						if (charts[_Globals2.default.hoverChartIndex]) {
							charts[_Globals2.default.hoverChartIndex].pointer.onDocumentMouseMove(e);
						}
					};
	   ...
	   */
			drop: function drop(e) {
				...
				if (this.selectionMarker) {
					...
					if (this.hasDragged || hasPinched) {
						...
						each(chart.axes, function (axis) {
							if (axis.zoomEnabled && defined(axis.min) && (hasPinched || pointer[{ xAxis: 'zoomX', yAxis: 'zoomY' }[axis.coll]])) {
								// #859, #3569
			...
			onDocumentMouseUp: function onDocumentMouseUp(e) {
				if (charts[_Globals2.default.hoverChartIndex]) {
					charts[_Globals2.default.hoverChartIndex].pointer.drop(e);
				}
			},
	   ...
	   */
			onContainerMouseLeave: function onContainerMouseLeave(e) {
				var chart = charts[_Globals2.default.hoverChartIndex];
			...
			onContainerMouseMove: function onContainerMouseMove(e) {
				...
				if (!defined(_Globals2.default.hoverChartIndex) || !charts[_Globals2.default.hoverChartIndex].mouseIsDown) {
					_Globals2.default.hoverChartIndex = chart.index;
				}
	   ...
	   */
			...
			onTrackerMouseOut: function onTrackerMouseOut(e) {
				...
				if (series && relatedTarget && !series.options.stickyTracking && !this.inClass(relatedTarget, 'highcharts-tooltip') && !this.inClass(relatedTarget, 'highcharts-series-' + series.index)) {
					// #2499, #4465
					series.onMouseOut();
				}
			},
	   ...
	   */
			setDOMEvents: function setDOMEvents() {
				...
				if (_Globals2.default.chartCount === 1) {
					addEvent(doc, 'mouseup', pointer.onDocumentMouseUp);
				}
				if (_Globals2.default.hasTouch) {
	   ...
	   */
			destroy: function destroy() {
				...
				if (!_Globals2.default.chartCount) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var charts = _Globals2.default.charts,
		    each = _Globals2.default.each,
		    extend = _Globals2.default.extend,
		    map = _Globals2.default.map,
		    noop = _Globals2.default.noop,
		    pick = _Globals2.default.pick,
		    Pointer = _Globals2.default.Pointer;
	...
	(function () {
		...
		if (win.PointerEvent || win.MSPointerEvent) {
			...
			var touches = {},
			    ...
			    translateMSPointer = function translateMSPointer(e, method, wktype, func) {
				var p;
				if ((e.pointerType === 'touch' || e.pointerType === e.MSPOINTER_TYPE_TOUCH) && charts[_Globals2.default.hoverChartIndex]) {
					func(e);
					p = charts[_Globals2.default.hoverChartIndex].pointer;
					p[method]({
						type: wktype,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var Legend,
		    ...
		    extend = _Globals2.default.extend,
		    isFirefox = _Globals2.default.isFirefox,
		    marginNames = _Globals2.default.marginNames,
		    merge = _Globals2.default.merge,
		    pick = _Globals2.default.pick,
		    setAnimation = _Globals2.default.setAnimation,
		    stableSort = _Globals2.default.stableSort,
		    win = _Globals2.default.win,
		    wrap = _Globals2.default.wrap;
		/**
	  * The overview of the chart's series
	  */
		Legend = _Globals2.default.Legend = function (chart, options) {
			this.init(chart, options);
		};
	   ...
	   */
			renderTitle: function renderTitle() {
				...
				if (titleOptions.text) {
					if (!this.title) {
						this.title = this.chart.renderer.label(titleOptions.text, padding - 3, padding - 4, null, null, null, null, null, 'legend-title').attr({ zIndex: 1 })
						/*= if (build.classic) { =*/
	   ...
	   */
			renderItem: function renderItem(item) {
				...
				if (!li) {
					...
					item.legendGroup = renderer.g('legend-item').addClass('highcharts-' + series.type + '-series highcharts-color-' + item.colorIndex + ' ' + (item.options.className || '') + (isSeries ? 'highcharts-series-' + item.index : '')).attr({ zIndex: 1 }).add(legend.scrollGroup);
	   	...
	   	legend.maxItemWidth = 0;
				...
				legend.offsetWidth = widthOption || Math.max((horizontal ? legend.itemX - initialItemX - itemDistance : itemWidth) + padding, legend.offsetWidth);
			},
	   ...
	   */
			render: function render() {
				...
				if (legendWidth > 0 && legendHeight > 0) {
					box[box.isNew ? 'attr' : 'animate'](box.crisp({ x: 0, y: 0, width: legendWidth, height: legendHeight }, box.strokeWidth()));
					box.isNew = false;
				}
	  ...
	  */
		...
		_Globals2.default.LegendSymbolMixin = {
	   ...
	   */
			drawRectangle: function drawRectangle(legend, item) {
				...
				legend.symbolWidth, symbolHeight, legend.options.symbolRadius || 0).addClass('highcharts-point').attr({
					zIndex: 3
				}).add(item.legendGroup);
			},
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var addEvent = _Globals2.default.addEvent,
		    animate = _Globals2.default.animate,
		    attr = _Globals2.default.attr,
		    doc = _Globals2.default.doc,
		    Axis = _Globals2.default.Axis,
		    // @todo add as requirement
		CanVGController = _Globals2.default.CanVGController,
		    createElement = _Globals2.default.createElement,
		    defaultOptions = _Globals2.default.defaultOptions,
		    discardElement = _Globals2.default.discardElement,
		    charts = _Globals2.default.charts,
		    ...
		    extend = _Globals2.default.extend,
		    fireEvent = _Globals2.default.fireEvent,
		    getStyle = _Globals2.default.getStyle,
		    grep = _Globals2.default.grep,
		    isString = _Globals2.default.isString,
		    Legend = _Globals2.default.Legend,
		    // @todo add as requirement
		marginNames = _Globals2.default.marginNames,
		    merge = _Globals2.default.merge,
		    Pointer = _Globals2.default.Pointer,
		...
		pick = _Globals2.default.pick,
		    ...
		    syncTimeout = _Globals2.default.syncTimeout,
		    win = _Globals2.default.win,
		    Renderer = _Globals2.default.Renderer,
		    useCanVG = _Globals2.default.useCanVG;
		/**
	  * The Chart class
	  ...
	  */
		var Chart = _Globals2.default.Chart = function () {
			this.getArgs.apply(this, arguments);
		};

		_Globals2.default.chart = function (a, b, c) {
			...
			layOutTitles: function layOutTitles(redraw) {
				...
				each(['title', 'subtitle'], function (key) {
					...
					if (title) {
						...
						title.css({ width: (titleOptions.width || autoWidth) + 'px' }).align(extend({
	   ...
	   */
			getContainer: function getContainer() {
				var chart = this,
				    ...
				    oldChartIndex,
				    Ren,
				    containerId = 'highcharts-' + _Globals2.default.idCounter++,
				    containerStyle;
				...
				chart.container = container = createElement('div', {
					...
					id: containerId
				}, containerStyle, chart.renderToClone || renderTo);

				// cache the cursor (#1650)
				chart._cursor = container.style.cursor;

				// Initialize the renderer
				Ren = _Globals2.default[optionsChart.renderer] || Renderer;
	   ...
	   */
			showCredits: function showCredits(credits) {
				if (credits.enabled && !this.credits) {
					this.credits = this.renderer.text(credits.text, 0, 0).addClass('highcharts-credits').on('click', function () {
						if (credits.href) {
	   ...
	   */
			isReadyToRender: function isReadyToRender() {
				...
				if (!svg && win == win.top && win.readyState !== 'complete' || useCanVG && !win.canvg) {
	  ...
	  */
			splashArray: function splashArray(target, options) {
				var oVar = options[target],
				    tArray = _Globals2.default.isObject(oVar) ? oVar : [oVar, oVar, oVar, oVar];
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var addEvent = _Globals2.default.addEvent,
		    ...
		    isObject = _Globals2.default.isObject,
		    isString = _Globals2.default.isString,
		    LegendSymbolMixin = _Globals2.default.LegendSymbolMixin,
	  ...
	  * @param {Object} options
	  */
		_Globals2.default.Series = function () {}; // @todo return this object

		_Globals2.default.Series.prototype = (_H$Series$prototype = {
	   ...
	   */
			autoIncrement: function autoIncrement() {
				...
				if (pointIntervalUnit === 'month' || pointIntervalUnit === 'year') {
					...
					date = pointIntervalUnit === 'month' ? +date[Date.hcSetMonth](date[Date.hcGetMonth]() + pointInterval) : +date[Date.hcSetFullYear](date[Date.hcGetFullYear]() + pointInterval);
	   ...
	   */
			...
			getCyclic: function getCyclic(prop, value, defaults) {
				...
				if (!value) {
					if (defined(userOptions['_' + indexName])) {
						// after Series.update()
	   ...
	   */
		...
		}, _defineProperty(_H$Series$prototype, 'getColor', function getColor() {
			if (this.options.colorByPoint) {
				this.options.color = null; // #4359, selected slice got series.color even when colorByPoint was set.
			} else {
					this.getCyclic('color', this.options.color || defaultPlotOptions[this.type].color, this.chart.options.colors);
				}
		}), _defineProperty(_H$Series$prototype, 'getSymbol', function getSymbol() {
		...
		}), _defineProperty(_H$Series$prototype, 'drawLegendSymbol', LegendSymbolMixin.drawLineMarker), _defineProperty(_H$Series$prototype, 'setData', function setData(data, redraw, animation, updatePoints) {
			var series = this,
		...
		}), _defineProperty(_H$Series$prototype, 'processData', function processData(force) {
			var series = this,
		...
		}), _defineProperty(_H$Series$prototype, 'cropData', function cropData(xData, yData, min, max) {
		...
		}), _defineProperty(_H$Series$prototype, 'generatePoints', function generatePoints() {
			var series = this,
			    options = series.options,
		...
		}), _defineProperty(_H$Series$prototype, 'getExtremes', function getExtremes(yData) {
		...
		}), _defineProperty(_H$Series$prototype, 'translate', function translate() {
		...
		}), _defineProperty(_H$Series$prototype, 'getValidPoints', function getValidPoints() {
			return grep(this.points, function (point) {
				return !point.isNull;
			});
		}), _defineProperty(_H$Series$prototype, 'setClip', function setClip(animation) {
			var chart = this.chart,
			    options = this.options,
			    renderer = chart.renderer,
			    inverted = chart.inverted,
		...
		}), _defineProperty(_H$Series$prototype, 'animate', function animate(init) {
			var series = this,
			    chart = series.chart,
			    clipRect,
		...
		}), _defineProperty(_H$Series$prototype, 'afterAnimate', function afterAnimate() {
			this.setClip();
			fireEvent(this, 'afterAnimate');
		}), _defineProperty(_H$Series$prototype, 'drawPoints', function drawPoints() {
			var series = this,
			    points = series.points,
			    chart = series.chart,
			    plotX,
				...
				while (i--) {
					...
					if (enabled && plotY !== undefined && !isNaN(plotY) && point.y !== null) {
						...
						if (graphic) {
							...
							point.graphic = graphic = chart.renderer.symbol(symbol, plotX - radius, plotY - radius, 2 * radius, 2 * radius, hasPointMarker ? pointMarkerOptions : seriesMarkerOptions).attr({ r: radius }).add(markerGroup);
		...
		}), _defineProperty(_H$Series$prototype, 'pointAttribs', function pointAttribs(point, state) {
		...
		}), _defineProperty(_H$Series$prototype, 'destroy', function destroy() {
			var series = this,
			    chart = series.chart,
		...
		}), _defineProperty(_H$Series$prototype, 'getGraphPath', function getGraphPath(points, nullsAsZeroes, connectCliffs) {
			var series = this,
			    options = series.options,
			    step = options.step,
			    graphPath = [],
			...
			return graphPath;
		}), _defineProperty(_H$Series$prototype, 'drawGraph', function drawGraph() {
			var series = this,
			    options = this.options,
			    graphPath = this.getGraphPath(),
			    props = [['graph', 'highcharts-graph',
			/*= if (build.classic) { =*/
			options.lineColor || this.color, options.dashStyle
			/*= } =*/
			]];
			...
			each(this.zones, function (zone, i) {
				...
				/*= if (build.classic) { =*/
				zone.color || series.color, zone.dashStyle || options.dashStyle
				/*= } =*/
				]);
			});
			...
			each(props, function (prop, i) {
				...
				if (graph) {
					...
					series[graphKey] = series.chart.renderer.path(graphPath).addClass('highcharts-graph ' + (prop[1] || '')).attr({ zIndex: 1 }) // #1069
					.add(series.group);
					...
					series[graphKey].attr(attribs).shadow(i < 2 && options.shadow); // add shadow to normal series (0) or to first zone (1) #3932
					/*= } =*/
				}
			});
		}), _defineProperty(_H$Series$prototype, 'applyZones', function applyZones() {
			var series = this,
			    chart = this.chart,
			    renderer = chart.renderer,
			    zones = this.zones,
		...
		}), _defineProperty(_H$Series$prototype, 'invertGroups', function invertGroups() {
			var series = this,
			    chart = series.chart;
		...
		}), _defineProperty(_H$Series$prototype, 'plotGroup', function plotGroup(prop, name, visibility, zIndex, parent) {
			var group = this[prop],
			    isNew = !group;
			...
			if (isNew) {
				...
				group.addClass('highcharts-series-' + this.index + ' highcharts-' + this.type + '-series highcharts-color-' + this.colorIndex + ' ' + (this.options.className || '')); // docs: className
			}

			// Place it on first and subsequent (redraw) calls
			group.attr({ visibility: visibility })[isNew ? 'attr' : 'animate'](this.getPlotBox());
			return group;
		}), _defineProperty(_H$Series$prototype, 'getPlotBox', function getPlotBox() {
			var chart = this.chart,
			    xAxis = this.xAxis,
			    yAxis = this.yAxis;
		...
		}), _defineProperty(_H$Series$prototype, 'render', function render() {
			var series = this,
			    chart = series.chart,
			    group,
			    options = series.options,
		...
		}), _defineProperty(_H$Series$prototype, 'redraw', function redraw() {
			var series = this,
			    chart = series.chart,
		...
		}), _defineProperty(_H$Series$prototype, 'kdDimensions', 1), _defineProperty(_H$Series$prototype, 'kdAxisArray', ['clientX', 'plotY']), _defineProperty(_H$Series$prototype, 'searchPoint', function searchPoint(e, compareX) {
			var series = this,
			    xAxis = series.xAxis,
			    yAxis = series.yAxis,
		...
		}), _defineProperty(_H$Series$prototype, 'buildKDTree', function buildKDTree() {
			var series = this,
		...
		}), _defineProperty(_H$Series$prototype, 'searchKDTree', function searchKDTree(point, compareX) {
			var series = this,
		...
		}), _H$Series$prototype); // end Series prototype
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  */
		Point = _Globals2.default.Point = function () {};
		Point.prototype = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	   ...
	   */
			showLoading: function showLoading(str) {
				...
				if (!loadingDiv) {
					...
					chart.loadingSpan = createElement('span', { className: 'highcharts-loading-inner' }, labelStyle, loadingDiv);
	   ...
	   */
			removePoint: function removePoint(i, redraw, animation) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var extendClass = _Globals2.default.extendClass,
		    Series = _Globals2.default.Series,
		    seriesTypes = _Globals2.default.seriesTypes;
		/**
	  * LineSeries object
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var defaultPlotOptions = _Globals2.default.defaultPlotOptions,
		    defaultSeriesOptions = _Globals2.default.defaultSeriesOptions,
		    extendClass = _Globals2.default.extendClass,
		    Color = _Globals2.default.Color,
		    each = _Globals2.default.each,
		    LegendSymbolMixin = _Globals2.default.LegendSymbolMixin,
	  ...
	  */
	   ...
	   */
	    ...
	    */
				addDummyPoints = function addDummyPoints(i, otherI, side) {
					var point = points[i],
			...
			drawGraph: function drawGraph() {
				...
				each(props, function (prop) {
					...
					if (area) {
						...
						series[areaKey] = series.chart.renderer.path(areaPath).addClass(prop[1]).attr({
							/*= if (build.classic) { =*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  */
	   ...
	   */
			getPointSpline: function getPointSpline(points, point, i) {
				var smoothing = 1.5,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		var Color = _Globals2.default.Color,
		    defaultPlotOptions = _Globals2.default.defaultPlotOptions,
		    defaultSeriesOptions = _Globals2.default.defaultSeriesOptions,
		    each = _Globals2.default.each,
		    extendClass = _Globals2.default.extendClass,
				...
				each(series.points, function (point) {
					...
					if (plotY !== undefined && !isNaN(plotY) && point.y !== null) {
						...
						if (graphic) {
							...
							point.graphic = graphic = renderer[point.shapeType](shapeArgs).addClass(point.getClassName()).add(point.group || series.group);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		console.log(_Globals2.default);
		var PiePoint,
		    addEvent = _Globals2.default.addEvent,
		    CenteredSeriesMixin = _Globals2.default.CenteredSeriesMixin,
		    defaultPlotOptions = _Globals2.default.defaultPlotOptions,
		    defaultSeriesOptions = _Globals2.default.defaultSeriesOptions,
		    defined = _Globals2.default.defined,
		    each = _Globals2.default.each,
	   ...
	   */
			translate: function translate(positions) {
				...
				series.getX = function (y, left) {
					...
					return positions[0] + (left ? -1 : 1) * (Math.cos(angle) * (positions[2] / 2 + labelDistance));
				};
				...
				for (i = 0; i < len; i++) {
					...
					point.labelPos = [positions[0] + radiusX + Math.cos(angle) * labelDistance, // first break of connector
				...
				each(series.points, function (point) {
					if (point.y !== null) {
						...
						if (graphic) {
							...
							point.graphic = graphic = renderer[point.shapeType](shapeArgs).addClass('highcharts-point' + (point.selected ? ' highcharts-point-select' : '')).addClass('highcharts-color-' + point.colorIndex).setRadialReference(series.center).attr(groupTranslation).add(series.group);
							...
							/*= if (build.classic) { =*/
							graphic.attr(series.pointAttribs(point, point.selected && 'select')).attr({ 'stroke-linejoin': 'round' }).shadow(shadow, shadowGroup);
							/*= } =*/
						}
					}
				});
						...
						// in the point options, or if they fall outside the plot area.
							...
							if (dataLabel) {
								...
								// create new label
									...
									str, 0, -9999, options.shape, null, null, options.useHTML, null, 'data-label').attr(attr).css(extend(style, moreStyle)).add(dataLabelsGroup);
		...
		Series.prototype.alignDataLabel = function (point, dataLabel, options, alignTo, isNew) {
			...
			if (visible) {
				...
				if (options.rotation) {
					...
					dataLabel[isNew ? 'attr' : 'animate'](alignAttr).attr({ // #3003
						align: options.align
					});
				} else {
	   ...
	   */
			seriesTypes.pie.prototype.verifyDataLabelOverflow = function (overflow) {
				...
				if (centerOption[0] !== null) {
					...
					// Auto center
					newSize = Math.max(center[2] - overflow[1] - overflow[3], // horizontal overflow
					minSize);
				...
				if (centerOption[1] !== null) {
					...
					// Auto center
					newSize = Math.max(Math.min(newSize, center[2] - overflow[0] - overflow[2] // vertical overflow
					), minSize);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	(function () {
		var Chart = _Globals2.default.Chart,
		    each = _Globals2.default.each,
		    pick = _Globals2.default.pick,
		    addEvent = _Globals2.default.addEvent;
	  ...
	  */
		Chart.prototype.hideOverlappingLabels = function (labels) {
			...
			var len = labels.length,
			    ...
			    parent2,
			    padding,
			    intersectRect = function intersectRect(x1, y1, w1, h1, x2, y2, w2, h2) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  */
		TrackerMixin = _Globals2.default.TrackerMixin = {
	   ...
	   */
			pan: function pan(e, panning) {
				...
				each(panning === 'xy' ? [1, 0] : [1], function (isX) {
					...
					if (axis.series.length && (goingLeft || newMin > Math.min(extremes.dataMin, extremes.min)) && (!goingLeft || newMax < Math.max(extremes.dataMax, extremes.max))) {
	  ...
	  */
	   ...
	   */
			onMouseOver: function onMouseOver(e, byProximity) {
				var point = this,
				    series = point.series,
				    chart = series.chart,
				    tooltip = chart.tooltip,
			...
			setState: function setState(state, move) {
				...
				if (point.graphic) {
					...
					if (state && markerStateOptions) {
						...
						if (!stateMarkerGraphic) {
							if (newSymbol) {
								series.stateMarkerGraphic = stateMarkerGraphic = chart.renderer.symbol(newSymbol, plotX - radius, plotY - radius, 2 * radius, 2 * radius).add(series.markerGroup);
