...
getPointsOptions: function () {
        ...
        return [{
                    x: typeOptions.point.x,
                    y: typeOptions.point.y,
    ...
    addControlPoints: function () {
        H.each(
            ...
            /*addControlPoints: function () {
                ...
                //var options = this.options.typeOptions,
                    //controlPointOptions = options.point.controlPoint || {};
                
                // 0 - one point only
                //controlPointOptions.index = controlPointOptions.index || 0;

                //this.addControlPoint(controlPointOptions, false);

console.log('12 addControlPoints', this, this.options.controlPointOptions);
...
//controlPoint.redraw();
                ...
                //this.options.controlPointOptions.positioner.call(this, this)
            ...
            redraw: function (animation, resize, setStartPoints) {
                ...
                //H.controllableMixin.redraw.call(this, animation);
            },
