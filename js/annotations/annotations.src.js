        ...
        eventEmitterMixin, /** @lends Annotation# */ {
            ...
            defaultOptions: {
                ...
                labelOptions: {
                     ...
                     * are defined, the format or text take precedence and the
                     * formatter is ignored. `This` refers to a * point object.
                     *
                     * @type {function}
                     * @sample highcharts/annotations/label-text/
                     *         Set labels text
                     ...
                     * the plot area. The justify option aligns the label
                 ...
                 * referenced by the point's id - or a new point with defined
            ...
            initShape: function (shapeOptions, index) {
                var controlPointOptions = this.options.controlPointOptions,
                    options = merge(
