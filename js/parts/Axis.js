...
import './Options.js';
import './Tick.js';
var color = H.color, defaultOptions = H.defaultOptions, deg2rad = H.deg2rad, format = H.format, getMagnitude = H.getMagnitude, merge = H.merge, normalizeTickInterval = H.normalizeTickInterval, Tick = H.Tick;
