...
var extend = U.extend, objectEach = U.objectEach, removeEvent = U.removeEvent, wrap = U.wrap;
import './Pointer.js';
var addEvent = H.addEvent, charts = H.charts, css = H.css, doc = H.doc, hasTouch = H.hasTouch, noop = H.noop, Pointer = H.Pointer, win = H.win;
