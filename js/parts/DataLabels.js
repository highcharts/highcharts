...
var defined = U.defined, extend = U.extend, isArray = U.isArray, objectEach = U.objectEach, splat = U.splat;
import './Series.js';
var arrayMax = H.arrayMax, format = H.format, merge = H.merge, noop = H.noop, pick = H.pick, relativeLength = H.relativeLength, Series = H.Series, seriesTypes = H.seriesTypes, stableSort = H.stableSort;
