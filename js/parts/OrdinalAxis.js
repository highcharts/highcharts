...
var addEvent = U.addEvent, defined = U.defined, extend = U.extend, pick = U.pick, timeUnits = U.timeUnits;
import './Chart.js';
import './Series.js';
// Has a dependency on Navigator due to the use of Axis.toFixedRange
import './Navigator.js';
var Axis = H.Axis, Chart = H.Chart, css = H.css, noop = H.noop, Series = H.Series;
