...
/**
 * @license Highstock JS v2.0.0-pre ()
 *
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/stock/2.0.0-pre/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com/stock/2.0.0-pre/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
