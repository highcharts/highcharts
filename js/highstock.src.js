...
/**
 * @license Highstock JS v2.1.5-modified ()
 *
...
H.defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/stock/2.1.5-modified/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.highcharts.com/stock/2.1.5-modified/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, style, forExport) {
		...
		desc.element.appendChild(document.createTextNode('Created with Highstock 2.1.5-modified'));
