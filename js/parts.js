...
var HighchartsConfig = {
		...
		parts: [
			...
			{name: 'LineSeries', component: 'Line', group: "Chart and Serie types", depends: {component: ['Core']}, baseUrl: 'parts'},
			{name: 'AreaSeries', component: 'Area', group: "Chart and Serie types", depends: {component: ['Core']}, baseUrl: 'parts'},
			{name: 'SplineSeries', component: 'Spline', group: "Chart and Serie types", depends: {component: ['Core']}, baseUrl: 'parts'},
			{name: 'AreaSplineSeries', component: 'AreaSpline', group: "Chart and Serie types", depends: {component: ['Core', 'Area','Spline']}, baseUrl: 'parts'},
			{name: 'ColumnSeries', component: 'Column', group: "Chart and Serie types", depends: {component: ['Core']}, baseUrl: 'parts'},
			{name: 'BarSeries', component: 'Bar', group: "Chart and Serie types", depends: {component: ['Core','Column']}, baseUrl: 'parts'},
			{name: 'ScatterSeries', component: 'Scatter', group: "Chart and Serie types", depends: {component: ['Core','Column']}, baseUrl: 'parts'},
			{name: 'PieSeries', component: 'Pie', group: "Chart and Serie types", depends: {component: ['Core'], name: ['CenteredSeriesMixin']}, baseUrl: 'parts'},
			...
			{name: 'OHLCSeries', component: 'OHLC', group: 'Stock', depends: {component: ['Stock', 'Column']}, baseUrl: 'parts'},
			{name: 'CandlestickSeries', component: 'Candlestick', group: 'Stock', depends: {component: ['Stock','OHLC', 'Column']}, baseUrl: 'parts'},
			{name: 'FlagsSeries', component: 'Flags', group: 'Stock', depends: {component: ['Stock','Column']}, baseUrl: 'parts'},
			{name: 'Scroller', component: 'Stock', group: 'Stock', depends: {component: ['Core','Line']}, baseUrl: 'parts'},
			...
			{name: 'AreaRangeSeries', component: 'Arearange', group: "Chart and Serie types", depends: {component: ['Column', 'Area']}, baseUrl: 'parts-more'},
			{name: 'AreaSplineRangeSeries', component: 'Areasplinerange', group: "Chart and Serie types", depends: {component: ['Arearange', 'Spline']}, baseUrl: 'parts-more'},
			{name: 'ColumnRangeSeries', component: 'Columnrange', group: 'Chart and Serie types', depends: {component: ['Core', 'Column', 'Arearange']}, baseUrl: 'parts-more'},
			...
			/* MODULES */
			{name: 'funnel.src', component: 'Funnel', group: "Chart and Serie types", depends: {component: ['Core', 'Datalabels', 'Pie']}, baseUrl: 'modules'},
			...
			{name: 'Intro', component: 'Heatmap', group: "Modules", depends: {component: ['Core', 'Column', 'Scatter']}, baseUrl: 'parts-map'},
		...
		groups: {
			'Core': { description: 'The Core of Highcharts', depends: {component: ['Line']}},
			'Stock': { description: 'Highstock lets you create stock or general timeline charts'},
			'Chart and Serie types': { description: 'All the serie types available with Highcharts. Note: Line series is the base serie, required by the Core module'},
		...
		components: {
			...
			'Areaspline': { description:  ''},
			'Areasplinerange': { description:  ''},
			'Columnrange': { description:  ''},
			'Gauge': { description:  ''},
			'BoxPlot': {description: 'A box plot, or box-and-whiskers chart, displays groups of data by their five point summaries: minimum, lower quartile, median, upper quartile and maximum. '},
			'Bubble': {description: 'Bubble charts allow three dimensional data to be plotted in an X/Y diagram with sized bubbles.'},
			'Waterfall': { description: 'Waterfall charts display the cumulative effects of income and expences, or other similar data. In Highcharts, a point can either be positive or negative, an intermediate sum or the total sum.'},
			...
			'ErrorBar': {description: 'An error bar series is a secondary series that lies on top of a parent series and displays the possible error range of each parent point.'}, 
