...
var HighchartsConfig = {
		...
		parts: [
			...
			{name: 'LogarithmicAxis', component: 'LogarithmicAxis', group: 'Features', depends: {component: ['Core']}, baseUrl: 'parts'},
		...
		components: {
			...
			'DateTimeAxis': {description: 'Enable support for an Axis based on time units'},
			'Plotlines or bands': {description: 'Enable drawing plotlines and -bands on your chart.'},
			'LogarithmicAxis': {description: 'Enable logarithmic axis. On a logarithmic axis the numbers along the axis increase logarithmically and the axis adjusts itself to the data series present in the chart.'},
