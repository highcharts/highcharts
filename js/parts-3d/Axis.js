...
var ZAxis, addEvent = H.addEvent, Axis = H.Axis, Chart = H.Chart, deg2rad = H.deg2rad, merge = H.merge, perspective = H.perspective, perspective3D = H.perspective3D, pick = H.pick, shapeArea = H.shapeArea, Tick = H.Tick, wrap = H.wrap;
/**
 * @optionparent xAxis
 */
var extendedOptions = {
