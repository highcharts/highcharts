...
H.extend(H.AdvancedLegend.prototype, {
    ...
    renderLegendGroup: function () {
        var renderer = this.chart.renderer; // TODO: fix TS
        if (!this.group) {
...
extend(H.LegendAdapter.prototype, {
    adjustMargins: function (margin, spacing) {
        ...
        if (chart.options.title) { // TODO: fix TS
    ...
    destroyItem: function (item) {
        this.legends.forEach(function (legend) {
            legend.destroyItem(item); // TODO: fix TS
        });
    },
...
wrap(H.Chart.prototype, 'renderLegend', function (originalFunc) {
    var index = this.collectionsWithUpdate.indexOf('legend'); // TODO: fix TS
    if (!this.isAdvancedLegendEnabled()) { // TODO: fix TS
...
addEvent(H.Series, 'afterSetOptions', function () {
    H.LegendItemMixin.prototype.setTargetLegendOptions(this); // TODO: fix TS
});
...
if (H.ColorAxis) {
    ...
    addEvent(H.ColorAxis.prototype, 'beforeBuildOptions', // TODO: fix TS
    function () {
...
if (H.BubbleLegend) {
    ...
    addEvent(H.BubbleLegend, 'afterSetOptions', // TODO: fix TS
    function () {
        H.LegendItemMixin.prototype.setTargetLegendOptions(this);
    });
    ...
    wrap(H.Chart.prototype, 'redrawLegend', function (originalFunc) {
        ...
        this.isDirtyLegend = false; // TODO: fix TS
    });
}
