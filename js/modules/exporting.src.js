...
var addEvent = U.addEvent, discardElement = U.discardElement, extend = U.extend, fireEvent = U.fireEvent, isObject = U.isObject, objectEach = U.objectEach, pick = U.pick, removeEvent = U.removeEvent;
import '../parts/Options.js';
import '../parts/Chart.js';
import chartNavigationMixin from '../mixins/navigation.js';
// create shortcuts
var defaultOptions = H.defaultOptions, doc = H.doc, Chart = H.Chart, createElement = H.createElement, css = H.css, merge = H.merge, isTouchDevice = H.isTouchDevice, win = H.win, userAgent = win.navigator.userAgent, SVGRenderer = H.SVGRenderer, symbols = H.Renderer.prototype.symbols, isMSBrowser = /Edge\/|Trident\/|MSIE /.test(userAgent), isFirefoxBrowser = /firefox/i.test(userAgent);
// Add language
