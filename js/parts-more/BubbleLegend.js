...
var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, isNumber = U.isNumber, objectEach = U.objectEach, pick = U.pick, stableSort = U.stableSort, wrap = U.wrap;
var Series = H.Series, Legend = H.Legend, Chart = H.Chart, color = H.color, merge = H.merge, noop = H.noop, setOptions = H.setOptions;
setOptions({
    legend: {
        /**
