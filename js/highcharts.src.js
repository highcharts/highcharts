...
H.defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/5.0-dev/modules/canvas-tools.js',
...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, style, forExport, allowHTML) {
		...
		desc.element.appendChild(document.createTextNode('Created with Highcharts 5.0-dev'));
