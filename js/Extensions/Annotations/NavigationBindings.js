...
var NavigationBindings = /** @class */ (function () {
     ...
     */
    NavigationBindings.prototype.getAssignedAxis = function (coords, xOrY) {
        objectEach(coords, function (value, prop) {
            coords[prop] = value.filter(function (coord) {
    ...
    navigation: {
        ...
        bindings: {
            ...
            rectangleAnnotation: {
                ...
                steps: [
                    function (e, annotation) {
                        var points = annotation.options.shapes[0].points, coords = this.chart.pointer.getCoordinates(e), coordsX = this.getAssignedAxis(coords, 'x'), coordsY = this.getAssignedAxis(coords, 'y'), x, y;
                        if (coordsX && coordsY) {
                            x = coordsX.value;
                            y = coordsY.value;
                            // Top right point
