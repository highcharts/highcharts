...
sudo ln -sf /usr/share/zoneinfo/Australia/Melbourne /etc/localtime && node -e 'require("./print_timezone.js").timezone()'
...
sudo ln -sf /usr/share/zoneinfo/America/Los_Angeles /etc/localtime && node -e 'require("./print_timezone.js").timezone()'
...
sudo ln -sf /usr/share/zoneinfo/Asia/Kolkata /etc/localtime && node -e 'require("./print_timezone.js").timezone()'
...
export TZ=UTC
sudo ln -sf /usr/share/zoneinfo/UTC /etc/localtime && node -e 'require("./print_timezone.js").timezone()'
...
sudo ln -sf /usr/share/zoneinfo/Atlantic/Reykjavik /etc/localtime && node -e 'require("./print_timezone.js").timezone()'
...
sudo ln -sf /usr/share/zoneinfo/Pacific/Fiji /etc/localtime && node -e 'require("./print_timezone.js").timezone()'
