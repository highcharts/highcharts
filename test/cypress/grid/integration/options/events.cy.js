describe('Grid Pro - events.', () => {
    ...
    it('Cell mouseOver / mouseOut event.', () => {
        // ColumnDefaults
        cy.get('.highcharts-grid-row[data-row-index="1"] > td[data-column-id="product"]')
            .trigger('mouseover');
        ...
        // ColumnOptions
        cy.get('.highcharts-grid-row[data-row-index="1"] > td[data-column-id="weight"]')
            .trigger('mouseover');
    ...
    it('AfterRender event.', () => {
        ...
        cy.get('.highcharts-grid-row[data-row-index="1"] > td[data-column-id="price"]')
            .dblclick({force: true})
            .find('input')
            .type('1{enter}');
    ...
    it('Resize column event.', () => {
        // ColumnDefaults
        cy.get('th[data-column-id="product"] > .highcharts-grid-column-resizer')
            .trigger('mousedown')
        ...
        // ColumnOptions
        cy.get('th[data-column-id="weight"] > .highcharts-grid-column-resizer')
            .trigger('mousedown')
            .trigger('mousemove', { clientX: 300, clientY: 300 })
            .trigger('mouseup');
