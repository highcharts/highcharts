describe('Grid events.', () => {
    ...
    it('Grid should be sorted initially by price in ascending order.', () => {
        ...
        cy.get('th[data-column-id="price"]').should('have.class', 'highcharts-grid-column-sorted-asc');
    });
    ...
    it('Should be able to turn off sorting.', () => {
        ...
        cy.get('th[data-column-id="price"]').should('have.not.class', 'highcharts-grid-column-sorted-asc');
    });
    ...
    it('Clicking two times on the `weight` column header should sort the table in descending order.', () => {
        ...
        cy.get('th[data-column-id="weight"]').should('have.class', 'highcharts-grid-column-sorted-desc');
    });
    ...
    it('Sorting the `icon` column should be possible by the code.', () => {
        ...
        cy.get('th[data-column-id="icon"]').should('have.class', 'highcharts-grid-column-sorted-asc');
    });
