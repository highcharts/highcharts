describe('Edit Mode options', () => {
    ...
    it('When disabling the dragDrop and resizer the menu should have only 3 items and resizer should not exist', () => {
        cy.toggleEditMode();
        cy.get('#dashboard-col-0').click();
        cy.get('.highcharts-dashboards-edit-toolbar-cell').children().should('have.length', 3);
