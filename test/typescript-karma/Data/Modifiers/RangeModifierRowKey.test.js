...
QUnit.test('RangeModifierRowKey.modify', async function (assert) {
    ...
    const rowKeys = table.getColumn(rowKeysId);
    console.log(rowKeys);
    // assert.equal(rowKeys.length, 5, 'The number of row keys should equal the number of rows');
