...
/* Morningstar fixed income taxonomy: super → primary → secondary (API
   encodes hierarchy only in flat keys; this table mirrors fixed-income-sectors-grid.html) */
const TAXONOMY = [
    { key: 'Government', label: 'Government',
        primaries: [
            { key: 'Government', label: 'Government',
                secondaries: ['Treasury', 'InflationProtected', 'AgencyorquasiAgency',
                    'InterestRateDerivative', 'TreasuryFutures'] },
            { key: 'GovernmentRelated', label: 'Government Related',
                secondaries: ['Supranational', 'GovernmentRelatedOther'] }
        ] },
    { key: 'Municipal', label: 'Municipal',
        primaries: [
            { key: 'MunicipalTaxable', label: 'Municipal Taxable',
                secondaries: ['TaxableGeneralObligationStateAndLocal', 'TaxableAdvanceRefunded',
            ...
            { key: 'MunicipalTaxExempt', label: 'Municipal Tax-Exempt',
                secondaries: ['TaxExemptGeneralObligationStateAndLocal', 'TaxExemptAdvanceRefunded',
                    'TaxExemptTobacco', 'TaxExemptEducation', 'TaxExemptHealth', 'TaxExemptHousing',
                    'TaxExemptIndustrial', 'TaxExemptTransportation', 'TaxExemptUtilities',
                    'TaxExemptWaterAndSewer', 'TaxExemptMiscRevenueorunspecified'] }
        ] },
    { key: 'Corporate', label: 'Corporate',
        primaries: [
            { key: 'BankLoan', label: 'Bank Loan',
                secondaries: ['BankLoanBasicMaterials', 'BankLoanConsumerCyclical',
                    'BankLoanFinancialServices', 'BankLoanRealEstate', 'BankLoanConsumerDefensive',
                    'BankLoanHealthCare', 'BankLoanUtilities', 'BankLoanCommunicationServices',
                    'BankLoanEnergy', 'BankLoanIndustrials', 'BankLoanTechnology', 'BankLoanUnspecified'] },
            { key: 'Convertible', label: 'Convertible',
                secondaries: ['ConvertibleBasicMaterials', 'ConvertibleConsumerCyclical',
                    'ConvertibleFinancialServices', 'ConvertibleRealEstate', 'ConvertibleConsumerDefensive',
                    'ConvertibleHealthCare', 'ConvertibleUtilities', 'ConvertibleCommunicationServices',
                    'ConvertibleEnergy', 'ConvertibleIndustrials', 'ConvertibleTechnology',
                    'ConvertibleUnspecified'] },
            { key: 'CorporateBond', label: 'Corporate Bond',
                secondaries: ['CorporateBasicMaterials', 'CorporateConsumerCyclical',
                    'CorporateFinancialServices', 'CorporateRealEstate', 'CorporateConsumerDefensive',
                    'CorporateHealthCare', 'CorporateUtilities', 'CorporateCommunicationServices',
                    'CorporateEnergy', 'CorporateIndustrials', 'CorporateTechnology', 'CorporateUnspecified'] },
            { key: 'PreferredStock', label: 'Preferred Stock',
                secondaries: ['PreferredBasicMaterials', 'PreferredConsumerCyclical',
                    'PreferredFinancialServices', 'PreferredRealEstate', 'PreferredConsumerDefensive',
                    'PreferredHealthCare', 'PreferredUtilities', 'PreferredCommunicationServices',
                    'PreferredEnergy', 'PreferredIndustrials', 'PreferredTechnology', 'PreferredUnspecified'] }
        ] },
    { key: 'Securitized', label: 'Securitized',
        primaries: [
            { key: 'AgencyMortgageBacked', label: 'Agency Mortgage-Backed',
                secondaries: ['AgencyPassThru', 'AgencyArm', 'AgencyCmo', 'Unspecified'] },
            { key: 'NonAgencyResidentialMortgageBacked', label: 'Non-Agency Residential MBS',
                secondaries: ['NonAgencyResidentialMortgageBacked'] },
            { key: 'CommercialMortgageBacked', label: 'Commercial Mortgage-Backed',
                secondaries: ['CommercialMortgageBacked'] },
            { key: 'CoveredBond', label: 'Covered Bond',
                secondaries: ['CoveredBond'] },
            { key: 'AssetBacked', label: 'Asset-Backed',
                secondaries: ['HomeEquity', 'CreditCard', 'Cboorcdo', 'Auto', 'StudentLoan',
                    'AssetBackedOther', 'Abs'] }
        ] },
    { key: 'CashAndEquivalents', label: 'Cash & Equivalents',
        primaries: [
            { key: 'CashAndEquivalents', label: 'Cash & Equivalents',
                secondaries: ['Cash', 'Corporate', 'Currency', 'DerivativeCashOffsets', 'Frn',
                    'Government', 'Gseoragency', 'Mbs', 'MoneyMarket', 'Municipal', 'CommercialPaper',
                    'RepurchaseAgreements', 'Tdorcd', 'Collateral', 'CashOther'] }
        ] },
    { key: 'Derivative', label: 'Derivative',
        primaries: [
            { key: 'Swap', label: 'Swap',
                secondaries: ['CreditDefaultSwap', 'TotalReturnSwap', 'DebtSwap'] },
            { key: 'Forwardorfuture', label: 'Forward/Future',
                secondaries: ['BondFuture', 'BondIndexFuture', 'CurrencyForwardorfuture', 'BondUnit'] },
            { key: 'Optionorwarrant', label: 'Option/Warrant',
                secondaries: ['BondOption', 'BondWarrant'] }
        ] }
];

const SECONDARY_LABELS = {
    Treasury: 'Treasury',
    InflationProtected: 'Inflation-Protected',
    AgencyorquasiAgency: 'Agency / Quasi-Agency',
    InterestRateDerivative: 'Interest Rate Derivative',
    TreasuryFutures: 'Treasury Futures',
    Supranational: 'Supranational',
    GovernmentRelatedOther: 'Other Government Related',
    TaxableGeneralObligationStateAndLocal: 'GO — State & Local',
    TaxableAdvanceRefunded: 'Advance Refunded',
    TaxableTobacco: 'Tobacco',
    TaxableEducation: 'Education',
    TaxableHealth: 'Health',
    TaxableHousing: 'Housing',
    TaxableIndustrial: 'Industrial',
    TaxableTransportation: 'Transportation',
    TaxableUtilities: 'Utilities',
    TaxableWaterAndSewer: 'Water & Sewer',
    TaxableMiscRevenueorunspecified: 'Misc. Revenue / Unspecified',
    TaxExemptGeneralObligationStateAndLocal: 'GO — State & Local',
    TaxExemptAdvanceRefunded: 'Advance Refunded',
    TaxExemptTobacco: 'Tobacco',
    TaxExemptEducation: 'Education',
    TaxExemptHealth: 'Health',
    TaxExemptHousing: 'Housing',
    TaxExemptIndustrial: 'Industrial',
    TaxExemptTransportation: 'Transportation',
    TaxExemptUtilities: 'Utilities',
    TaxExemptWaterAndSewer: 'Water & Sewer',
    TaxExemptMiscRevenueorunspecified: 'Misc. Revenue / Unspecified',
    AgencyPassThru: 'Agency Pass-Thru',
    AgencyArm: 'Agency ARM',
    AgencyCmo: 'Agency CMO',
    Unspecified: 'Unspecified',
    NonAgencyResidentialMortgageBacked: 'Non-Agency Residential MBS',
    CommercialMortgageBacked: 'Commercial MBS',
    ...
    AssetBackedOther: 'Other Asset-Backed',
    Abs: 'ABS',
    Cash: 'Cash',
    Corporate: 'Corporate',
    Currency: 'Currency',
    DerivativeCashOffsets: 'Derivative Cash Offsets',
    Frn: 'FRN',
    Government: 'Government',
    Gseoragency: 'GSE / Agency',
    Mbs: 'MBS',
    ...
    BondIndexFuture: 'Bond Index Future',
    CurrencyForwardorfuture: 'Currency Forward / Future',
    BondUnit: 'Bond Unit',
...
const SECONDARY_PIN = {
    Government: 'CashAndEquivalents',
    Municipal: 'CashAndEquivalents',
    Corporate: 'CashAndEquivalents',
    Unspecified: 'AgencyMortgageBacked',
...
/** Super-sector accent colors (aligned with Morningstar-style reference palette). */
...
/** Emoji marker per super-sector (only on super-sector tree rows). */
const SUPER_SECTOR_ICONS = {
    Government: '🏛️',
    Municipal: '🏙️',
    Corporate: '🏢',
    Securitized: '📑',
...
function fixedIncomeSectorsTreeColumns(bd) {
    const id = [];
    const path = [];
    const name = [];
    const value = [];
    /** Numeric long weight (rescaled %) for sparkline column */
    const weight = [];
    /** Share of immediate parent as a bare % (no label). */
    const segmentShare = [];
    const lbl = s => {
        s = s
            .replace(/([a-z0-9])([A-Z])/g, '$1 $2')
            .replace(/([A-Z]{2,})([A-Z][a-z])/g, '$1 $2')
            .replace(/orunspecified/gi, 'or unspecified')
            .replace(/orquasi/gi, 'or quasi')
            .replace(/orcdo/gi, 'or CDO')
            .replace(/orcd/gi, 'or CD')
            .replace(/orfuture/gi, 'or future')
            .replace(/orwarrant/gi, 'or warrant')
            .replace(/\s+/g, ' ')
            .trim();
    ...
    const pct = v => fmt(v) + '%';
    const readRescaled = field => readBdNum(bd, field);
    const iconFor = superKey =>
        (SUPER_SECTOR_ICONS[superKey] ?? '◇') + '\u00a0';
    const row = (p, n, wNum, superKey, parentVal) => {
        id.push(p);
        path.push(p);
        const isSuperRow = p.split('/').length === 1;
        name.push((isSuperRow ? iconFor(superKey) : '') + n);
        value.push(pct(wNum));
        weight.push(wNum);
        if (
            parentVal === null ||
            !Number.isFinite(parentVal) ||
            parentVal <= 0
        ) {
            segmentShare.push('—');
        } else {
            segmentShare.push(fmt(100 * wNum / parentVal) + '%');
        }
    };

    for (const sup of TAXONOMY) {
        const sp = sup.key;
        const vSuper = readRescaled(`fixedIncSuperSector${sp}PercLongRescaled`);
        row(sp, sup.label, vSuper, sp, null);
        /** One primary identical to super (e.g. Cash) — skip redundant tree row. */
        const skipDupPrimary =
            sup.primaries.length === 1 && sup.primaries[0].key === sp;

        for (const pri of sup.primaries) {
            const p2 = `${sp}/${pri.key}`;
            const vPri = readRescaled(
                `fixedIncPrimarySector${pri.key}PercLongRescaled`
            );
            if (!skipDupPrimary) {
                row(p2, pri.label, vPri, sp, vSuper);
            }
            const secondaries = pri.secondaries.filter(secKey =>
                (SECONDARY_PIN[secKey] ?? pri.key) === pri.key
            );
            const parentForLeaf = skipDupPrimary ? vSuper : vPri;
            const leafPrefix = skipDupPrimary ? sp : `${sp}/${pri.key}`;
            for (const secKey of secondaries) {
                const p3 = `${leafPrefix}/${secKey}`;
                const vSec = readRescaled(
                    `fixedIncSecondarySector${secKey}PercLongRescaled`
                );
                row(
                    p3,
                    SECONDARY_LABELS[secKey] || lbl(secKey),
                    vSec,
                    sp,
                    parentForLeaf
                );
    ...
    return {
        id, path, name, value, weight, segmentShare
    };
}

const treeColumns = fixedIncomeSectorsTreeColumns(
