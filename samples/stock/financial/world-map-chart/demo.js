...
async function renderChart() {
    ...
    function renderChartInTooltip(point) {
        Highcharts.chart('hc-tooltip', {
            ...
            xAxis: {
                ...
                labels: {
                    useHTML: true,
                    format: `<img src="https://www.highcharts.com/samples/graphics/world-map-icons/${point.iconPath}.svg" height="40" width="40" />`,
                    y: -12
                },
                type: 'category'
            },
    ...
    Highcharts.chart('bar-container', {
        ...
        title: {
            text:
                'Regional Exposure of Fidelity <br> ' +
                'Special Situations Security',
            align: 'left',
            style: {
                fontSize: '22px'
            }
        ...
        xAxis: {
            ...
            labels: {
                useHTML: true,
                format:
                    '<img src="https://www.highcharts.com/samples/graphics/world-map-icons/{axis.series.1.options.data.(pos).iconPath}.svg" height="40" width="40" />',
                y: -12
            },
            type: 'category'
        },
        credits: {
            text:
                'Copyright (c) 2026 Highsoft AS, Based on data from ' +
                'Natural Earth | Highcharts.com ©',
            position: {
                align: 'left',
                x: 0
            }
