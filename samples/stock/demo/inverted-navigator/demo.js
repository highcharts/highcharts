const eventsData = [{
    ...
    lbl: 'The newspaper',
    location: 'Strasbourg',
    details: 'The first newspaper was invented by Johann Carolus. It was named <i>Relation aller Fürnemmen und gedenckwürdigen Historien</i> (Account of all distinguished and commemorable stories). The Relation is recognised by the World Association of Newspapers, as well as many authors, as the world\'s first newspaper.'
}, {
    x: -11399592920000,
    y: 1,
    lbl: 'Telescope',
    location: 'Netherlands',
    details: 'Patent applied for by Hans Lippershey. Actual inventor unknown since it seemed to already be a common item being offered by the spectacle makers in the Netherlands with Jacob Metius also applying for patent and the son of Zacharias Janssen making a claim 47 years later that his father invented it.'

}, {
    x: -11020901720000,
    y: 1,
    lbl: 'Compound microscopes',
    details: 'A combination of an objective lens with an eyepiece to view a real image, first appear in Europe. Apparently derived from the telescope, actual inventor unknown, variously attributed to Zacharias Janssen (his son claiming it was invented in 1590), Cornelis Drebbel, and Galileo Galilei.'
}, {
    x: -10705368920000,
    y: 1,
    lbl: 'Slide rule',
    ...
    y: 1,
    lbl: 'Barometer',
    details: 'Invented by Evangelista Torricelli, or possibly up to three years earlier by Gasparo Berti. Although Evangelista Torricelli is universally credited with inventing the barometer in 1643, historical documentation also suggests Gasparo Berti, an Italian mathematician and astronomer, unintentionally built a water barometer sometime between 1640 and 1643. French scientist and philosopher René Descartes described the design of an experiment to determine atmospheric pressure as early as 1631, but there is no evidence that he built a working barometer at that time.'
}, {
    x: -10074216920000,
    y: 1,
    lbl: 'Vacuum pump',
    details: 'A vacuum pump is a type of pump device that draws gas particles from a sealed volume in order to leave behind a partial vacuum. The first vacuum pump was invented in 1650 by Otto von Guericke, and was preceded by the suction pump, which dates to antiquity.'
}, {
    x: -9884828120000,
    y: 1,
    lbl: 'Pendulum clock',
    details: 'Invented by Christiaan Huygens. It was first conceptualized in 1637 by Galileo Galilei but he was unable to create a working model.'
}, {
    x: -9663989720000,
    y: 1,
    lbl: 'Friction machine',
    details: 'The first electrostatic generators are called friction machines because of the friction in the generation process. A primitive form of frictional machine was invented around 1663 by Otto von Guericke, using a sulphur globe that could be rotated and rubbed by hand'
}, {
    x: -9159068120000,
    y: 1,
    lbl: 'Pressure cooker',
    details: 'In 1679, French physicist Denis Papin, better known for his studies on steam, invented the steam digester in an attempt to reduce the cooking time of food. His airtight cooker used steam pressure to raise the water\'s boiling point, thus cooking food more quickly. In 1681 Papin presented his invention to the Royal Society of London as a scientific study; he was later elected as a member.'
}, {
    x: -8212383320000,
    y: 1,
    lbl: 'Piano',
    ...
    x: -6318927320000,
    y: 1,
    lbl: 'First steam-powered vehicle capable of carrying passengers',
    details: 'Invented by Nicolas-Joseph Cugnot. This invention is effectively the first automobile.'
}, {
    x: -6161160920000,
    y: 1,
    lbl: 'Boring mahcine',
    details: 'Invented by John Wilkinson, the boring mahcine is considered by some to be the first machine tool.'
}, {
    x: -5877164120000,
    y: 1,
    lbl: 'Firt manned hot air balloon.',
    ...
    x: -5214476120000,
    y: 1,
    lbl: 'Steam locomotive',
    details: 'Richard Trevithick built the first steam locomotive known to have hauled a load over a distance at Pen-y-darren in 1804, although he produced an earlier locomotive for trial at Coalbrookdale in 1802.'
}, {
    x: -5025173720000,
    y: 1,
    lbl: 'Wrist watch',
    ...
    y: 1,
    lbl: 'Karplan turbine',
    details: 'The Kaplan turbine is a propeller-type water turbine which has adjustable blades. It was developed in 1913 by Austrian professor Viktor Kaplan, who combined automatically adjusted propeller blades with automatically adjusted wicket gates to achieve efficiency over a wide range of flow and water level.'
}, {
    x: -1301049130000,
    y: 1,
    lbl: 'turbo-jet engine',
    ...
    y: 1,
    lbl: 'Nylon',
    details: 'The first fully synthetic fiber is produced by Wallace Carothers while working at DuPont.'
}, {
    x: -922357930000,
    y: 1,
    lbl: 'Cavity magnetron',
    details: 'John Randall and Harry Boot would develop the high power, microwave generating, cavity magnetron, later applied to commercial Radar and Microwave oven appliances.'
}, {
    x: -733055530000,
    y: 1,
    lbl: 'Ejector seat',
    details: 'James Martin invents the ejector seat, inspired by the death of his friend and test pilot Captain Valentine Baker in an aeroplane crash in 1942.'
}, {
    x: -606825130000,
    y: 1,
    lbl: 'Video game',
    details: 'Bertie the Brain is one of the first games developed in the early history of video games. It was built in Toronto by Josef Kates for the 1950 Canadian National Exhibition. The four meter (13 foot) tall computer allowed exhibition attendees to play a game of tic-tac-toe against an artificial intelligence.'
}, {
    x: -417436330000,
    y: 1,
    lbl: 'Hard disk drive',
    details: 'The first production IBM hard disk drive, the 350 disk storage, shipped in 1957 as a component of the IBM 305 RAMAC system. It was approximately the size of two large refrigerators and stored five million six-bit characters (3.75 megabytes) on a stack of 52 disks (100 surfaces used). The 350 had a single arm with two read/write heads, one facing up and the other down, that moved both horizontally between a pair of adjacent platters and vertically from one pair of platters to a second set. Variants of the IBM 350 were the IBM 355, IBM 7300 and IBM 1405.'
}, {
    x: -164975530000,
    y: 1,
    lbl: 'Shinkansen',
    ...
    x: 119021270000,
    y: 1,
    lbl: 'Graphical user interface (GUI)',
    details: 'The first commercial graphical user interface is introduced in 1973 on the Xerox Alto. The modern GUI is later popularized by the Xerox Star and Apple Lisa.'
}, {
    x: 339946070000,
    y: 1,
    lbl: 'Flash memory',
    details: 'Flash memory (both NOR and NAND types) is invented by Fujio Masuoka while working for Toshiba. It is formally introduced to the public in 1984.'
}, {
    x: 623942870000,
    y: 1,
    lbl: 'World Wide Web',
    details: 'The Web was invented by English computer scientist Tim Berners-Lee while working at CERN. He was motivated by the problem of storing, updating, and finding documents and data files in that large and constantly changing organization, as well as distributing them to collaborators outside CERN.'
}, {
    x: 813245270000,
    y: 1,
    lbl: 'DVD',
    details: 'DVD is an optical disc storage format, invented and developed by Philips, Sony, Toshiba, and Panasonic in 1995. DVDs offer higher storage capacity than compact discs while having the same dimensions.'
}, {
    x: 971098070000,
    y: 1,
    lbl: 'Geocaching',
    details: 'First documented placement of Geocaching, an outdoor recreational activity, in which participants use a Global Positioning System (GPS) receiver or mobile device and other navigational techniques to hide and seek containers, took place on May 3, 2000, by Dave Ulmer of Beavercreek, Oregon.'
}, {
    x: 1255094870000,
    y: 1,
    lbl: 'Highcharts',
    ...
    x: 1476019670000,
    y: 1,
    lbl: 'Laser Interferometer Gravitational-Wave Observatory',
    details: 'The Laser Interferometer Gravitational-Wave Observatory makes the first observation of gravitational waves, fulfilling Einstein\'s prediction.'
}, {
    x: 1602250070000,
    y: 1,
    lbl: 'Artificial intelligence-assisted coding',
    details: ''
}];
...
Highcharts.stockChart('container', {
    ...
    title: {
        text: 'List of stock historic inventions.',
        align: 'left'
    },
    subtitle: {
    ...
    tooltip: {
        ...
        formatter: function () {
            ...
            if (this.point.options.location) {
                tooltipString = '<div style="width: 140px;">Location: ' +
                    this.point.options.location + '</div>';
            }
            tooltipString += '<div style="width: 140px;">Year: ' +
                Highcharts.dateFormat('%Y', this.x) + '</div>';
            if (this.point.options.details) {
                tooltipString += '<div style="width: 300px;"> ' +
                    this.point.options.details + '</div>';
            }
