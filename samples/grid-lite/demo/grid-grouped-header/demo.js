Grid.grid("container", {
  ...
  /* Use the header API option to define the grouped header structure, and in this example at the same time format headers. */
  header: [
    "dessert",
    {
  ...
  columns: [
    /* You can also format headers in the columns[] API option if that's prefered */
    {
      id: "dessert",
      header: {
