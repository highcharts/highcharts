(async () => {
    ...
    const topology = await fetch(
        'https://code.highcharts.com/mapdata/historical/countries/us-2013/us-va-all-2013.topo.json'
    ...
    Highcharts.mapChart('container', {
        ...
        subtitle: {
            text: 'Source map: <a href="https://code.highcharts.com/mapdata/historical/countries/us-2013/us-va-all-2013.topo.json">Virginia (2013)</a>'
        },
