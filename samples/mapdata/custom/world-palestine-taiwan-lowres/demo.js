(async () => {
    ...
    const topology = await fetch(
        'https://code.highcharts.com/mapdata/custom/world-palestine-taiwan-lowres.topo.json'
    ...
    Highcharts.mapChart('container', {
        ...
        subtitle: {
            text: 'Source map: <a href="https://code.highcharts.com/mapdata/custom/world-palestine-taiwan-lowres.topo.json">World with Palestine areas and Taiwan, low resolution</a>'
        },
