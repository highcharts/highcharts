(async () => {
    ...
    const topology = await fetch(
        'https://code.highcharts.com/mapdata/custom/africa-sadr.topo.json'
    ...
    Highcharts.mapChart('container', {
        ...
        subtitle: {
            text: 'Source map: <a href="https://code.highcharts.com/mapdata/custom/africa-sadr.topo.json">Africa with SADR-administered areas</a>'
        },
