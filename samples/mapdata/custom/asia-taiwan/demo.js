(async () => {
    ...
    const topology = await fetch(
        'https://code.highcharts.com/mapdata/custom/asia-taiwan.topo.json'
    ...
    Highcharts.mapChart('container', {
        ...
        subtitle: {
            text: 'Source map: <a href="https://code.highcharts.com/mapdata/custom/asia-taiwan.topo.json">Asia with Taiwan</a>'
        },
