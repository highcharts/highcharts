(async () => {
    ...
    const topology = await fetch(
        'https://code.highcharts.com/mapdata/custom/world-taiwan-highres3.topo.json'
    ...
    Highcharts.mapChart('container', {
        ...
        subtitle: {
            text: 'Source map: <a href="https://code.highcharts.com/mapdata/custom/world-taiwan-highres3.topo.json">World with Taiwan, ultra high resolution</a>'
        },
