(async () => {
    ...
    const data = [
        ...
        ['us-ut', 58], ['us-hi', 59], ['us-ak', 60], ['gu-3605', 61],
        ['mp-ti', 62], ['mp-sa', 63], ['mp-ro', 64], ['as-6515', 65],
        ['as-6514', 66], ['pr-3614', 67], ['vi-3617', 68], ['vi-6398', 69],
        ['vi-6399', 70]
    ];
    ...
    Highcharts.mapChart('container', {
        ...
        subtitle: {
            text: 'Source map: <a href="http://code.highcharts.com/mapdata/countries/us/custom/us-all-territories.topo.json">United States of America with Territories</a>'
        },
