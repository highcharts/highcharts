$(function () {
    ...
    $('#container').highcharts({
        ...
        plotOptions: {
            bar: {
                tooltip: {
                    pointFormat: '<span>{series.name}</span>: <b>' +
                        '{point.y}</b><br/>',
                    valueDecimals: 2,
                    valueSuffix: ''
                }
        ...
        series: [{
            name: 'Value',
            dataLabels: {},
            data: [2203996749.00, 2181327870.00, 1842143410.00, 1724601434.00,
                1391446136.00, 1377422297.00, 1218712623.00, 1057997532.00,
                794479667.00, 6492893821.00]
        }]
    });
