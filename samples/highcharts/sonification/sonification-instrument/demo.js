...
document.getElementById('play').onclick = function () {
    ...
    const instr = new Instrument(ctx, ctx.destination, {
        synthPatch: JSON.parse(document.getElementById('synthPreset').textContent),
        capabilities: {
            tremolo: true,
            filters: true
        }
    ...
    [
        ...
        { note: 'g4', pan: 0.3, volume: 0.7, tremoloDepth: 0.6, tremoloSpeed: 0.5, lowpassFreq: 2400, highpassResonance: -1 },
        { note: 'f4', pan: 0.6, volume: 0.8, tremoloDepth: 0.6, tremoloSpeed: 0.6, lowpassFreq: 4000, highpassResonance: -3 },
        { note: 'e4', pan: 0.8, volume: 0.9, tremoloDepth: 0.7, tremoloSpeed: 0.6, lowpassFreq: 7000, highpassResonance: 0 },
        { note: 'c4', pan: 1, volume: 1, tremoloDepth: 0.7, tremoloSpeed: 0.75, lowpassFreq: 20000, highpassFreq: 0 }
    ].forEach((e, ix) =>
