...
Highcharts.chart('container', {
    ...
    tooltip: {
        formatter: function () {
            const heading = this.series.name === 'Snitt' ?
                'Snitt' :
                'Vinteren ' + (parseInt(this.series.name, 10) - 1) + '-' +
                    this.series.name;

            return '<b>' + heading + '</b><br/>' +
                Highcharts.dateFormat('%e. %b', this.x, true) + ':<br/>' +
    ...
    series: [{
        ...
        data: [[28382400000, 0.00], [29332800000, 0.25], [30542400000, 1.41],
            ...
            [39438000000, 2.81], [40302000000, 2.63], [41684400000, 2.77],
