...
Highcharts.chart('container', {
    ...
    accessibility: {
        ...
        screenReaderSection: {
            beforeChartFormat:
                '<p>A venn diagram showing 4 major benefits of designing for accessibility, ' +
                    ...
                    mouseOver: function () {
                        ...
                        nextMouseOver = setTimeout(function () {
                            ...
                            if (mq.matches) {
                                ...
                                getEl('caption-content').innerHTML =
                                    label.innerHTML;
                            } else {
            ...
            data: [
                {
                    ...
                    accessibility: {
                        description:
                            'Drive Innovation - Accessibility features in products and services often solve unanticipated problems for all users.'
                    },
                    name: 'innovation',
                ...
                },
                {
                    ...
                    accessibility: {
                        description:
                            'Enhance your brand - Accessible content will not only enhance customer loyalty and brand awareness, but also improve organic search results.'
                    },
                    name: 'brand',
                ...
                },
                {
                    ...
                    accessibility: {
                        description:
                            'Extend Market Reach - Reach the 1.3 billion people world-wide who are affected by a visual impairment with accessible content.'
                    },
                    dataLabels: {
                        y: 0,
                        x: 0,
                ...
                },
                {
                    ...
                    accessibility: {
                        description:
                            'Minimize Legal Risk - You or your customer might be facing a lawsuit if your software products are not accessible.'
                    },
