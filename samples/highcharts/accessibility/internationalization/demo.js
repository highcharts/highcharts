    ...
    (data) => {
        const chartOptions = {
            ...
            accessibility: {
                ...
                screenReaderSection: {
                    beforeChartFormat:
                        '<p>The chart is demonstrating that you can switch between multiple languages in the same chart.</p><p>Financial line chart showing AAPL stock prices, with an additional navigator series showing an overview of the stock.</p>'
                },
                series: {
        ...
        const initialOptions = JSON.parse(
            JSON.stringify(Highcharts.getOptions())
        );
            ...
            createChart(
                Highcharts.merge(chartOptions, {
                    ...
                    accessibility: {
                        ...
                        screenReaderSection: {
                            beforeChartFormat:
                                '<p>The chart is demonstrating that you can switch between multiple languages in the same chart.</p><p>Finansielt linjediagram som viser AAPL aksjepriser, med tilhørende navigeringsserie som gir et overblikk over aksjen.</p>'
                        }
                    },
                    rangeSelector: {
                        buttons: [
            ...
            createChart(
                Highcharts.merge(chartOptions, {
                    ...
                    accessibility: {
                        ...
                        screenReaderSection: {
                            beforeChartFormat:
                                '<p>The chart is demonstrating that you can switch between multiple languages in the same chart.</p><p>Liniendiagramm des AAPL-Aktienkurses mit zusätzlichem Navigationsdiagramm für einen Überblick über den Aktienkurs.</p>'
                        }
                    },
                    rangeSelector: {
                        buttons: [
