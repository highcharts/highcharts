            ...
            dataLabels: {
                ...
                formatter: function () {
                    if (
                        this.point ===
                        this.series.points[
                            Math.floor(this.series.points.length / 2)
                        ]
                    ) {
    ...
    series: [
        {
            ...
            data: [
                ...
                ['Acción Latina', 50000],
                [
                    'American Indian Community Cultural Center for the Arts SF (AICCCA-SF)',
                    50000
                ],
        ...
        },
        {
            ...
            data: [2273366, 2273366, 2273366, 2273366, 2273366, 2273366],
            pointStart: 10,
            color: '#EC6E65'
        },
        {
        ...
        },
        {
            ...
            data: [660000, 660000, 660000, 660000, 660000, 660000, 660000],
            pointStart: 34,
            color: colors[3]
        }
    ]
