    ...
    var GenericCandlestickSeries = extendClass(ColumnSeries, {
        ...
        drawPoints: function () {
            ...
            points.forEach(function (point) {
                var boxpath, numberOfBoxes, boxes;
                ...
                if (point.plotY !== UNDEFINED) {
                    ...
                    for (var i = 0; i < numberOfBoxes; i++) {
                        bottomBox =
                            mathRound(point.plotYValues[i + 1]) + crispCorr;
                        topBox =
                            mathRound(
                                point.plotYValues[
                    ...
                    path = [
                        'M',
                        crispX,
                        mathRound(point.plotYValues[1]) + crispCorr,
                        'L',
                        crispX,
                    ...
                    if (graphic) {
                        ...
                        graphic.path = chart.renderer
                            .path(path)
                            .attr(pointAttr)
                            .add(graphic);
                        for (i = 0; i < boxes.length; i++) {
                            graphic['path' + i] = chart.renderer
                                .path(boxes[i])
                                .attr(pointAttr)
                                .add(graphic);
                        }
