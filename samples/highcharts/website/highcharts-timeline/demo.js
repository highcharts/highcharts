...
const employees = [{ x: 1257033600000, y: 1 },
    ...
    { x: Date.UTC(2023, 0, 31), y: 39 },
    { x: Date.UTC(2023, 1, 28), y: 39 },
    { x: Date.UTC(2023, 2, 31), y: 40 },
    { x: Date.UTC(2023, 3, 30), y: 41 },
    { x: Date.UTC(2023, 4, 31), y: 41 },
    { x: Date.UTC(2023, 5, 30), y: 40 },
    { x: Date.UTC(2023, 6, 31), y: 38 }
];
const revData = [
    [1259622000000, 16],
    [1262300400000, 15],
