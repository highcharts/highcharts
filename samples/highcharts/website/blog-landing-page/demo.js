...
const network = Highcharts.chart('network', {
    chart: {
        type: 'networkgraph',
        marginTop: 0,
        animation: {
    ...
    tooltip: {
        ...
        formatter: function () {
            ...
            switch (this.color) {
                case dirDist50:
                    info =
                        'is an airport <b>more than 50</b> direct distinations';
                    break;
                case dirDist10:
                    info =
                        'is an airport <b>more than 10</b> direct distinations';
                    break;
                case dirDistLess10:
                    info =
                        'is an airport <b>less than 10</b> direct distinations';
                    break;
                default:
                //
            }
...
function animateCharts() {
    ...
    let newData = [];
    let count = 0;
    const planetCycle = setInterval(function () {
    ...
    let scattercount = -1;
    const scatterChange = setInterval(function () {
        ...
        if (scattercount < 3) {
            ...
            scatter.xAxis[0].setExtremes(xmin, xmax);
            scatter.yAxis[0].setExtremes(ymin, ymax);
        } else {
            clearInterval(scatterChange);
        }
    }, 2000);
