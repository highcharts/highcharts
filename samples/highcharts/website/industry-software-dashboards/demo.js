...
function weather() {
    ...
    // Update board after changing weather
    // station or parameter (measurement type)
...
// eslint-disable-next-line max-len
const pollingControls = document.getElementById('cloud-monitoring-data-controls');
