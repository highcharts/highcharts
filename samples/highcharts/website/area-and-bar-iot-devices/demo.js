...
fetch('https://raw.githubusercontent.com/u-raza/highcharts_broken_area/master/_data/sorted_data.csv')
    ...
    .then(data => {
        ...
        lines.forEach((line, lineNo) => {
            ...
            var totalReturned = parseFloat(items[1] *
                parseFloat(items[4]) / 100);
            if ((lineNo + 3) % 4 === 0) {
