...
let chartToChange;
let seriesNum;
let imagePath = 'https://cdn.rawgit.com/highcharts/highcharts/4b2b993a59d2358c85dbef61bfcd9e02547ce83a/samples/graphics/xmas-card-2020/';
...
itemChart = Highcharts.chart('container', {
        ...
        scatter:{ 
            dataLabels:{
                ...
                formatter:function (){
                    ...
                    return '<div class="message" style="background-color:#fff;'
    ...
    { //10
        ...
        data: [
            { name:'white star',y: 2, 
                marker:{ symbol:'url(' + imagePath + 'white-star-big.svg)',
                    radius:20 } },
            { name:'red star',y:2, color:'#64A12D', 
                marker:{ symbol:'url(' + imagePath + 'red-star.svg)',
                    radius:20 } },
            { name:'white dot',y:1, color:'#fff' },
            { name:'big blue star',y:2,  
                marker:{ symbol:'url(' + imagePath + 'blue-star-big.svg)'
                    ,radius:20 } },
            { name:'green dot',y:1, color:Highcharts.getOptions().colors[4] },
            { name:'big green flake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-flake-big.svg)'
                    ,radius:20 } },
            { name:'red dot',y:1, color:Highcharts.getOptions().colors[5] },
            { name:'big white flake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-flake-big.svg)'
                    ,radius:20 } },
            { name:'big blueflake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'blue-flake-big.svg)'
                    ,radius:20 } },
            { name:'purple dot',y:1, color:Highcharts.getOptions().colors[4] },
            //10
            { name:'green star 1',y:1, 
                marker:{ symbol:'url(' + imagePath + 'green-star.svg)'
                    ,radius:20 } },
            //11
            { name:'sun disk',y:1, 
                marker:{ symbol:'url(' + imagePath + 'sun-disk.svg)'
                    ,radius:20 } },
            { name:'orange dot',y:1, color:Highcharts.getOptions().colors[3] },
            { name:'red flake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'red-flake.svg)'
                    ,radius:20 } },
            { name:'white star',y:2, 
                marker:{ symbol:'url(' + imagePath + 'blue-star-big.svg)'
                    ,radius:20 } },
            ...
            { name:'big blue star',y:2,  
                marker:{ symbol:'url(' + imagePath + 'blue-star-big.svg)'
                    ,radius:20 } },
            { name:'green dot',y:1, color:Highcharts.getOptions().colors[4] },
            { name:'big green flake 1',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-flake-big.svg)'
                    ,radius:20 } },
            { name:'red dot',y:1, color:Highcharts.getOptions().colors[5] },
            { name:'big green flake 2',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-flake-big.svg)'
                    ,radius:20 } },
            { name:'big blueflake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'blue-flake-big.svg)'
                    ,radius:20 } },
            { name:'purple dot',y:1, color:Highcharts.getOptions().colors[4] },
            { name:'green star 2',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-star.svg)'
                    ,radius:20 } },
            { name:'big red star',y:2, 
                marker:{ symbol:'url(' + imagePath + 'red-star-big.svg)'
                    ,radius:20 } },
            { name:'orange dot',y:1, color:Highcharts.getOptions().colors[3] },
            { name:'red flake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'red-flake.svg)'
            ...
            { name:'big blue star',y:2,  
                marker:{ symbol:'url(' + imagePath + 'blue-star-big.svg)'
                    ,radius:20 } },
            { name:'green dot',y:1, color:Highcharts.getOptions().colors[4] },
            { name:'big green flake 3',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-flake-big.svg)'
                    ,radius:20 } },
            { name:'red dot',y:1, color:Highcharts.getOptions().colors[5] },
            { name:'big green flake 4',y:2, 
                marker:{ symbol:'url(' + imagePath + 'green-flake-big.svg)'
                    ,radius:20 } },
            { name:'big blueflake',y:2, 
                marker:{ symbol:'url(' + imagePath + 'blue-flake-big.svg)'
...
let soundChart = Highcharts.chart('soundContainer', {
    chart: {
        type: 'scatter'
    },
    title: {
...
function openCard(){
    ...
    setTimeout(function (){
        ...
        let santaSki = setInterval(skiInterval,7500);  
        /* eslint-disable no-unused-vars */ 
