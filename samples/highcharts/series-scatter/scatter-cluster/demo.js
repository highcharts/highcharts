...
var pathkmeansOut = kmeans(pathbased, 3);
var pathdbScanOut = dbscan(pathbased, 2, 10);
var pathHierOut = hierarchical(pathbased, 3);
...
var pathkmeansId = pathkmeansOut.assignments;
var pathdbScanId = pathdbScanOut.assignments;
var pathHierId = pathHierOut.assignments;
console.log(dsHierId);
const datasets = [engytime, ds577, pathbased];
const clusterIds = [
