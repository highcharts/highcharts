...
// Every dataset requires hyperparameter tuning. Here the hyperparameters
// are tuned to best show the differences between the different clustering
// algorithms.
...
function udc() {
    let dataset;
    const d = document.getElementById('datasetSelector').value;
    switch (d) {
    case 0:
        dataset = 'engytime';
        break;
