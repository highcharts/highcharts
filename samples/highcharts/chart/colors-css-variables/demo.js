...
Highcharts.chart('container', {
    ...
    chart: {
        ...
        plotBorderColor: 'var(--grid-color)'
    },
    ...
    colorAxis: {
        min: 0,
        minColor: 'var(--data-color-min)',
        maxColor: 'var(--data-color-max)',
