    ...
    series: [
        {
            ...
            data: [
                ...
                [Date.UTC(1970, 10, 30), 0.06],
                [Date.UTC(1970, 11,  3), 0.18],
                [Date.UTC(1970, 11,  6), 0.29],
                [Date.UTC(1970, 11,  9), 0.39],
                [Date.UTC(1970, 11, 12), 0.51],
                [Date.UTC(1970, 11, 15), 0.48],
                [Date.UTC(1970, 11, 18), 0.46],
                [Date.UTC(1970, 11, 21), 0.44],
                [Date.UTC(1970, 11, 24), 0.46],
                [Date.UTC(1970, 11, 27), 0.45],
                [Date.UTC(1970, 11, 30), 0.41],
                [Date.UTC(1971, 0,  3), 0.61],
                [Date.UTC(1971, 0,  6), 0.51],
                [Date.UTC(1971, 0,  9), 0.58],
                [Date.UTC(1971, 0, 12), 0.56],
                [Date.UTC(1971, 0, 15), 0.75],
                [Date.UTC(1971, 0, 18), 0.78],
                [Date.UTC(1971, 0, 21), 0.95],
                [Date.UTC(1971, 0, 24), 0.84],
                [Date.UTC(1971, 0, 27), 0.81],
                [Date.UTC(1971, 0, 30), 0.8],
                [Date.UTC(1971, 1,  3), 0.79],
                [Date.UTC(1971, 1,  6), 0.83],
                [Date.UTC(1971, 1,  9), 0.85],
                [Date.UTC(1971, 1, 12), 0.91],
                [Date.UTC(1971, 1, 15), 0.8],
                [Date.UTC(1971, 1, 18), 0.76],
                [Date.UTC(1971, 1, 21), 0.78],
                [Date.UTC(1971, 1, 24), 0.65],
                [Date.UTC(1971, 1, 27), 0.59],
                [Date.UTC(1971, 2,  3), 0.62],
                [Date.UTC(1971, 2,  6), 0.74],
                [Date.UTC(1971, 2,  9), 0.9],
                [Date.UTC(1971, 2, 12), 0.85],
                [Date.UTC(1971, 2, 15), 0.84],
                [Date.UTC(1971, 2, 18), 0.88],
                [Date.UTC(1971, 2, 21), 0.89],
                [Date.UTC(1971, 2, 24), 0.86],
                [Date.UTC(1971, 2, 27), 0.87],
                [Date.UTC(1971, 2, 30), 0.76],
                [Date.UTC(1971, 3,  3), 0.79],
                [Date.UTC(1971, 3,  6), 0.72],
                [Date.UTC(1971, 3,  9), 0.73],
                [Date.UTC(1971, 3, 12), 0.68],
                [Date.UTC(1971, 3, 15), 0.69],
                [Date.UTC(1971, 3, 18), 0.68],
                [Date.UTC(1971, 3, 21), 0.57],
                [Date.UTC(1971, 3, 24), 0.42],
                [Date.UTC(1971, 3, 27), 0.2],
                [Date.UTC(1971, 3, 30), 0.09],
                [Date.UTC(1971, 4,  3), 0.04],
                [Date.UTC(1971, 4,  6), 0.05],
                [Date.UTC(1971, 4,  9), 0.03],
                [Date.UTC(1971, 4, 12), 0]
            ]
        }, {
