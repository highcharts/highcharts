Highcharts.chart('container', {
    ...
    series: [{
        ...
        tooltip: {
            pointFormat: '<span class="highcharts-color-0">' +
        ...
        yAxis: 1,
        data: [
            [48, 51], [68, 73], [92, 110], [128, 136], [140, 150], [171, 179],
            [135, 143], [142, 149], [204, 220], [189, 199], [95, 110], [52, 56]
        ],
        tooltip: {
        ...
        tooltip: {
            pointFormat: '<span class="highcharts-color-2">' +
