    ...
    (assert) => {
        ...
        assert.strictEqual(
            ...
            disparityIndexIndicator.points.length +
                disparityIndexIndicator.options.params.period -
                1,
        ...
        assert.deepEqual(
            ...
            [
                1.1144449207029574, 1.3490648008414567, 1.6322750117675797,
                2.6402889657985704, 2.8860332841794816, 2.6852781984196885,
                3.0319331749375835, 4.1346396871887725, 3.3858908875563842,
                3.7335815492812077, 2.5854068148671345, 2.163383919922417
            ],
        ...
        assert.deepEqual(
            disparityIndexIndicator.yData,
            [
                -7.092691921307613, -3.9269586752566594, -5.8500476636354275,
                -5.606831111872415, -6.785019785958244, -0.5353437237847145,
                1.2668575271480607
            ],
        ...
        assert.strictEqual(
            baseSeries.points.length,
            disparityIndexIndicator.points.length +
                2 * disparityIndexIndicator.options.params.period -
                2,
        ...
        assert.deepEqual(
            disparityIndexIndicator.yData,
            [
                0.1254026201375433, -0.6706594647717171, 4.10189870982814,
                4.070431440521995
            ],
        ...
        assert.deepEqual(
            disparityIndexIndicator.yData,
            [-0.9115961290560005, -0.1503205703016479, 1.8686054467028232],
        ...
        assert.deepEqual(
            disparityIndexIndicator.yData,
            [
                2.439024390244402, -20.661157024793912, 2.8571428571434447,
                -12.528473804100868, 2.783725910064944, -5.243676742752136
            ],
        ...
        assert.strictEqual(
            baseSeries.points.length,
            disparityIndexIndicator.points.length +
                3 * disparityIndexIndicator.options.params.period -
                3,
        ...
        assert.deepEqual(
            disparityIndexIndicator.yData,
            [
                1.886792452831727, -7.283702213281587, 4.102656786555333,
                -1.9574468085127743
            ],
            `After setting one dimension data:
            the Disparity Index values should be correct.`
