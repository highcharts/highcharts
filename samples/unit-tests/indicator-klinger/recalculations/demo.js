QUnit.skip('Test Klinger calculations on data updates.', function (assert) {
    ...
    assert.deepEqual(
        ...
        [
            ...
            [-40216789.100235, 0],
            [-34443122.1494497, 0],
            [-29825829.269541997, 0],
            [-24763621.56112, 0],
            [-20206548.188729, 0],
            [-15679322.757195998, 0],
            [-17321240.882546004, 0],
            [-15613208.146280997, 0],
            [-17268102.206136, 55813492.159980685],
            [-15792572.694454003, 45373264.393393],
            [-13295706.896371998, 36635287.666558],
            [-10532589.346125, 29502288.443282],
            [-7836346.357963003, 23783020.187652],
            [-12480504.229340002, 19265967.823993],
            [-14934713.545528997, 14730757.53066],
            [-17209842.196491, 10492833.091204],
            [-14579861.310812999, 6535308.0501047],
            [-11651018.290220004, 3518855.2842593],
            [-14181685.567842998, 1351730.4879051],
            [-12239377.426339999, -867328.94863034]
        ],
        'Correct values'
    );
});
