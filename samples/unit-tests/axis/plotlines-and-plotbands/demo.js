...
QUnit.test('General tests', function (assert) {
    var chart = Highcharts.chart('container', {
        ...
        series: [{
            data: [
                2900.9, 701.5, 10006.4, 12009.2, 1404.0,
                1076.0, 135.6, 148.5, 21006.4
            ]
        }]
    });
...
QUnit.test(
    ...
    function (assert) {
        ...
        assert.strictEqual(
            chart.container
                .getElementsByClassName('highcharts-plot-bands-0')
                .length,
            1,
    ...
    var chart = Highcharts.chart('container', {
        xAxis: {
            ...
            plotBands: [{
                ...
                to: 3,
                label: {
                    text: 'I will dissapear if you zoom in <br/>so ' +
        ...
        var chart = Highcharts.chart('container', {
            ...
            series: [{
                data: [
                    ...
                    216.4, 100, 110, 120, 101, 115, 128, 99, 80, 132
                ],
                pointStart: Date.UTC(2010, 0, 1),
                pointInterval: 24 * 3600 * 1000
            }]
