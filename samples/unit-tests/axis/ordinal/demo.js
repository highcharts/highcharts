...
QUnit.test(
    'Panning ordinal axis on mobile devices- lin2val calculation, #13238',
    function (assert) {
        const data = [
...
QUnit.test(
    'lin2val- unit test for values outside the plotArea.',
    function (assert) {
        const axis = {
            transA: -0.04,
            min: 3.24,
        ...
        axis.ordinal.getIndexOfPoint =
            ...
            ].Additions.prototype.getIndexOfPoint;
        axis.ordinal.findIndexOf =
            // eslint-disable-next-line no-underscore-dangle
            Highcharts._modules[
                'Core/Axis/OrdinalAxis.js'
            ].Additions.prototype.findIndexOf;
...
QUnit.test(
    'Ordianl axis, data grouping and boost module, #14055.',
    (assert) => {
