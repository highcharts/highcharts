...
QUnit.test('The tickPositions option', function (assert) {
    var chart = Highcharts.chart('container', {
        ...
        series: [
            {
                data: [
                    134002, 135188, 135647, 136552, 166109, 166769, 141139,
                    141879, 140443, 141188, 178745, 179790, 141385, 142161,
                    143365, 144679, 175150, 141385, 142161, 143365, 144679,
                    175150, 144679, 175150, 175150
                ]
            }
        ]
    });
...
QUnit.test('No ticks on short axis (#3195)', function (assert) {
    var chart = Highcharts.chart('container', {
        ...
        series: [
            ...
            {
                data: [
                    217020, 217020, 217020, 217020, 217020, 217020, 217020,
