QUnit.test('Test PSAR calculations on data updates.', function (assert) {
    ...
    assert.deepEqual(
        ...
        [
            9.35, 9.35, 10.33, 10.277, 10.226, 10.177, 10.103, 10.034, 8.95,
            8.996, 9.087, 9.26, 9.491, 9.699, 9.951, 10.224, 10.498, 10.729,
            10.923, 11.94, 11.907, 11.875, 11.82, 11.734, 11.614, 11.506,
            11.331, 11.112, 10.924, 10.693, 10.499, 10.289, 10.057, 9.858, 9.68,
            9.65, 8.97, 9.012, 9.052, 9.114, 9.172, 10.08, 10.045, 9.989, 9.896,
            9.81
        ],
        'Correct values'
    );
