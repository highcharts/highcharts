QUnit.test('Test algorithm on data updates.', function (assert) {
        ...
        series: [
            {
                id: 'additional',
                data: [
                    23.11, 23.12, 23.13, 23.11, 23.12, 23.13, 23.11, 23.12,
                    23.13
                ]
            },
            {
    ...
    assert.deepEqual(
        ...
        [
            22.1775, 22.141875, 22.205, 22.37703125, 22.29078125, 22.2940234375,
            22.188828125, 22.332822265625
        ],
        'Correct values'
    );
    ...
    assert.deepEqual(
        chart.series[2].yData,
        [
            23.75, 23.824444444444, 23.941851851851, 23.674074074074,
            23.793621399177
        ],
        'Correct values'
    );
