(function () {
                ...
                if (
                    ...
                    while (!isAligned(this)) {
                        if (index < primaryIndex) {
                            newTickPos =
                                this.tickPositions[0] - this.tickInterval;
    ...
    QUnit.test('alignThreshold, positive-negative', function (assert) {
        var originalAdjustTickAmount =
            Highcharts.Axis.prototype.adjustTickAmount;
        ...
        try {
            ...
            var chart = Highcharts.chart('container', {
                ...
                series: [
                    ...
                    {
                        data: [
                            129.9, 271.5, 306.4, -29.2, 544.0, 376.0, 435.6,
                            348.5, 216.4, 294.1, 35.6, 354.4
                        ],
                        yAxis: 1
                    }
                ]
