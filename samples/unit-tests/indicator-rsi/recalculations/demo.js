QUnit.test('Test RSI calculations on data updates.', function (assert) {
    ...
    assert.deepEqual(
        ...
        [
            70.532789, 66.318562, 66.54983, 69.406305, 66.355169, 57.974856,
    ...
    chart.series[0].update({
        data: [
            443389, 440902, 441497, 436124, 443278, 448264, 450955, 454245,
            458433, 460826, 458931, 460328, 456140, 462820, 462820, 460028,
            460328, 464116, 462222, 456439, 462122, 462521, 457137, 464515,
            457835, 453548, 440288, 441783, 442181, 445672, 434205, 426628,
            431314
        ],
        type: 'line'
    });
