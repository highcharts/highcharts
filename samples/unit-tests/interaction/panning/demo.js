QUnit.test('#14426: Vertical panning after zooming', assert => {
    ...
    assert.strictEqual(chart.yAxis[0].min, 0, 'It should be possible to pan down to 0');
    ...
    assert.strictEqual(chart.yAxis[0].max, 0, 'It should be possible to pan up to 0');
});