QUnit.test('Test algorithm on data updates.', function (assert) {
    var chart = Highcharts.stockChart('container', {
        series: [
            ...
            },
            {
                id: 'volume',
                data: [
                    7849, 11692, 10575, 13059, 20734, 29630, 17705, 7259, 10475,
                    5204, 3423, 3962, 4096, 3766, 4239, 8040, 6957, 18172,
                    22226, 14614, 12320, 15008, 8880, 22694, 10192, 10074, 9412,
                    10392, 8927, 7460
                ]
            },
            {
    ...
    var expectedData = [
        -0.121, -0.1, -0.066, -0.026, -0.062, -0.048, -0.009, -0.009, -0.005,
        -0.058, -0.015
    ];
