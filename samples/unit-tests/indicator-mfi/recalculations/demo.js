QUnit.test('Test MFI calculations on data updates.', function (assert) {
    ...
    chart.series[0].setData([
        [Date.UTC(2010, 12, 3), 24.8000, 24.8283, 24.3205, 24.7486],
        [Date.UTC(2010, 12, 6), 24.8000, 24.7586, 24.5993, 24.7088],
        [Date.UTC(2010, 12, 7), 24.8000, 25.1568, 24.7785, 25.0373],
        [Date.UTC(2010, 12, 8), 24.8000, 25.5848, 24.9477, 25.5450],
        [Date.UTC(2010, 12, 9), 24.8000, 25.6844, 24.8083, 25.0672],
        ...
        [Date.UTC(2011, 1, 3), 24.8000, 25.3061, 25.0274, 25.0473],
        [Date.UTC(2011, 1, 4), 24.8000, 25.1170, 24.3404, 24.4500],
        [Date.UTC(2011, 1, 5), 24.8000, 24.6889, 24.2708, 24.5694],
        [Date.UTC(2011, 1, 6), 24.8000, 24.5495, 23.8925, 24.0219],
        [Date.UTC(2011, 1, 7), 24.8000, 24.2708, 23.7780, 23.8825],
        [Date.UTC(2011, 1, 10), 24.8000, 24.2708, 23.7232, 24.2011],
        [Date.UTC(2011, 1, 11), 24.8000, 24.5993, 24.2011, 24.2807],
        [Date.UTC(2011, 1, 12), 24.8000, 24.4798, 24.2409, 24.3305],
        [Date.UTC(2011, 1, 13), 24.8000, 24.5595, 23.4345, 24.4400],
        [Date.UTC(2011, 1, 14), 24.8000, 25.1600, 24.2700, 25.0000]
    ], false);

    chart.series[1].setData([
        [Date.UTC(2010, 12, 3), 18730.144],
        [Date.UTC(2010, 12, 6), 12271.740],
        [Date.UTC(2010, 12, 7), 24691.414],
        [Date.UTC(2010, 12, 8), 18357.606],
        [Date.UTC(2010, 12, 9), 22964.080],
        ...
        [Date.UTC(2011, 1, 3), 7457.091],
        [Date.UTC(2011, 1, 4), 11798.009],
        [Date.UTC(2011, 1, 5), 12366.132],
        [Date.UTC(2011, 1, 6), 13294.865],
        [Date.UTC(2011, 1, 7), 9256.870],
        [Date.UTC(2011, 1, 10), 9690.604],
        [Date.UTC(2011, 1, 11), 8870.318],
        [Date.UTC(2011, 1, 12), 7168.965],
        [Date.UTC(2011, 1, 13), 11356.180],
        [Date.UTC(2011, 1, 14), 13379.374]
    ], false);
