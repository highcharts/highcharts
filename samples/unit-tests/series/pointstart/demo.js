...
QUnit.test('Tooltip shown week formats, should be date (#3418)', function (assert) {
    ...
    function setMouseOnPoint(pointNumber) {
        ...
        textOfTooltip = chart.tooltip.label.element.childNodes[4].childNodes[0].childNodes[0].data;
