QUnit.test('Data sorting animation', function (assert) {
    ...
    function getCalculatedXPos(point) {
        return Math.round(
            point.series.xAxis.toPixels(point.x) -
            point.series.xAxis.left
        );
    }
...
QUnit.test('Data sorting animation - removing and adding points', function (assert) {
    ...
    try {
        ...
        var chart = Highcharts.chart('container', {
            ...
            labelD,
            labelCInitPos = labelC.xy.y - parseFloat(labelC.styles.fontSize),
            labelDInitPos,
