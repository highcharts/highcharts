QUnit.test(
    'Test Detrended Price Oscillator calculations on data updates.',
    function (assert) {
        ...
        assert.deepEqual(
            ...
            [
                405.419, 385.8262, 333.4952, 307.5786, 244.6262, 351.8357,
                360.1167, 219.9619, 212.0452, 146.6548, 74.4929, 6.4214,
                26.5762, -3.6262
            ],
            'Correct values'
        );
        ...
        assert.deepEqual(
            ...
            [
                405.419, 385.8262, 333.4952, 307.5786, 244.6262, 351.8357,
                360.1167, 219.9619, 212.0452, 146.6548, 74.4929, 6.4214, 26.5762
            ],
