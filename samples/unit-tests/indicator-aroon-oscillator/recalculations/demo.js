QUnit.test(
    'Test Aroon Oscillator calculations on data updates.',
    function (assert) {
        ...
        assert.strictEqual(
            ...
            'Initial number of Aroon Oscillator points is correct'
        );

        chart.series[0].addPoint([
            1475617400000, 112.06, 113.31, 112.43, 112.95
        ]);
        ...
        assert.strictEqual(
            ...
            chart.series[1].points.length +
                chart.series[1].options.params.period,
            'After addPoint number of Aroon Oscillator points is correct'
        );
        ...
        assert.strictEqual(
            ...
            chart.series[1].points.length +
                chart.series[1].options.params.period,
            'After setData number of Aroon Oscillator points is correct'
        );
        ...
        assert.deepEqual(
            ...
            [
                71.4286, 71.4286, 71.4286, 71.4286, 71.4286, 64.2857, 57.1429,
                50.0, 28.5714, 28.5714, 28.5714, 21.4286
            ],
            'Correct values'
        );
