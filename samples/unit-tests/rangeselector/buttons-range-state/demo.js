QUnit.test('Range selector buttons general tests.', function (assert) {
    ...
    assert.deepEqual(
        chart.options.rangeSelector.buttonTheme.style,
        { color: 'red' },
        'The range selector buttons style should not be deleted from the chart options (#13798).'
    );
});
