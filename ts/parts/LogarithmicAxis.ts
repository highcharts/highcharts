...
declare global {
    namespace Highcharts {
        interface Axis {
            _minorAutoInterval?: (null|number);
            getLogTickPositions(
                interval: number,
                min: number,
                max: number,
 ...
 * @return {Array<number>}
 */
Axis.prototype.getLogTickPositions = function (
 ...
 * @return {number}
 */
Axis.prototype.log2lin = function (this: Highcharts.Axis, num: number): number {
 ...
 * @return {number}
 */
Axis.prototype.lin2log = function (this: Highcharts.Axis, num: number): number {
