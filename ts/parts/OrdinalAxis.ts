...
extend(Axis.prototype, /** @lends Axis.prototype */ {
     ...
     * @return {void}
     */
    beforeSetTickPositions: function (this: Highcharts.Axis): void {
        var axis = this,
            len,
     ...
     * @return {Array<number>}
     */
    getExtendedPositions: function (this: Highcharts.Axis): Array<number> {
        var axis = this,
            chart = axis.chart,
     ...
     *          Generated ticks
     */
    getOverscrollPositions: function (this: Highcharts.Axis): Array<number> {
        var axis = this,
