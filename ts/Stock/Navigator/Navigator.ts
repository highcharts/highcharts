...
class Navigator {
    ...
    public static navigator(
        ...
        const element = U.isString(renderTo) ? document.getElementById(renderTo) : renderTo;
        ...
        return new Navigator(chartMock);
    };
    ...
    public constructor (chart: ChartMock);


    public constructor(chart: Chart | ChartMock) {


        if(chart.isMock) {
            this.initStandalone(chart as ChartMock);
        } else {
            this.init(chart)
        }
    }
    ...
    public initStandalone(chartMock: ChartMock) {
