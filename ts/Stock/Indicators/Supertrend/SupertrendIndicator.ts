...
const {
    seriesTypes: { atr: ATRIndicator, sma: SMAIndicator }
} = SeriesRegistry;
...
class SupertrendIndicator extends SMAIndicator {
     ...
     */
    public static defaultOptions: SupertrendOptions = merge(
        SMAIndicator.defaultOptions,
        {
            /**
             * Paramters used in calculation of Supertrend indicator series
             * points.
             *
             * @excluding index
             */
            params: {
                ...
                multiplier: 3,
                /**
                 * The base period for indicator Supertrend Indicator
                 * calculations. This is the number of data points which are
                 * taken into account for the indicator calculations.
                 */
                period: 10
            },
            /**
             * Color of the Supertrend series line that is beneath the main
             * series.
             *
             * @sample {highstock} stock/indicators/supertrend/ Example with
             *         risingTrendColor
             *
             * @type
            ...
            /**
             * Color of the Supertrend series line that is above the main
             * series.
             *
             * @sample {highstock} stock/indicators/supertrend/ Example with
             *         fallingTrendColor
     ...
     * */
    public init(): void {
        let options: SupertrendOptions, parentOptions: SeriesOptions;
    ...
    public drawGraph(): void {
            ...
            supertrendLineOptions: SupertrendLineObject = {
                ...
                bottom: {
                    styles: {
                        lineWidth: indicOptions.lineWidth,
                        lineColor:
                            indicOptions.risingTrendColor || indicOptions.color,
                        dashStyle: indicOptions.dashStyle
                    }
                },
        ...
        // Generate lines:
        objectEach(groupedPoitns, function (values, lineName): void {
            indicator.points = values;
            indicator.options = merge(
                (supertrendLineOptions as any)[lineName].styles,
                gappedExtend
            );
            indicator.graph = (indicator as any)['graph' + lineName + 'Line'];
            SMAIndicator.prototype.drawGraph.call(indicator);

            // Now save line
            (indicator as any)['graph' + lineName + 'Line'] = indicator.graph;
        });
    ...
    public getValues<TLinkedSeries extends LineSeries>(
        ...
        ATRData = (
            ATRIndicator.prototype.getValues.call(this, series, {
                period: period
            }) as any
        ).yData;
