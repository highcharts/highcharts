...
/**
 * Tree input generated by grouping flat rows by source column values.
 */
export interface TreeInputGroupingOptions {
    /**
     * Type of the tree input.
     */
    type: 'grouping';
    ...
    /**
     * Source column ID or IDs used as row grouping levels.
     *
     * Each configured column is hidden from the projected table and
     * represented by generated parent rows in `groupColumn`.
     *
     * @sample grid-pro/tree-view/row-grouping Row grouping
     */
    ...
    /**
     * Synthetic column ID containing generated group row labels.
     *
     * @default 'Group'
     */
    groupColumn?: string;
