...
function scrollLegendToItem(legend: Highcharts.Legend, itemIx: number): void {
    let itemPage = legend.allItems[itemIx].pageIx,
...
function shouldDoLegendA11y(chart: Chart): boolean {
    let items = chart.legend && chart.legend.allItems,
...
H.Chart.prototype.highlightLegendItem = function (ix: number): boolean {
    let items = this.legend.allItems,
...
addEvent(Legend, 'afterColorizeItem', function (
    ...
    let chart: Highcharts.AccessibilityChart = this.chart as any,
 ...
 */
let LegendComponent: typeof Highcharts.LegendComponent =
...
extend(LegendComponent.prototype, /** @lends Highcharts.LegendComponent */ {
    ...
    addLegendProxyGroup: function (this: Highcharts.LegendComponent): void {
        let a11yOptions = this.chart.options.accessibility,
    ...
    onKbdArrowKey: function (
        ...
        let res = chart.highlightLegendItem(
    ...
    onKbdClick: function (
        ...
        let legendItem: LegendItem = this.chart.legend.allItems[
