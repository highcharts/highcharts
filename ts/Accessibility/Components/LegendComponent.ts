...
const { getChartTitle } = ChartUtils;
...
addEvent(
    Legend,
    'afterColorizeItem',
    function (e: { item: LegendItem; visible: boolean | undefined }): void {
...
extend(
    ...
    /** @lends Highcharts.LegendComponent */ {
        ...
        init: function (this: Highcharts.LegendComponent): void {
            ...
            this.addEvent(Legend, 'afterRender', function (): void {
                // #15902
                if (
            ...
            items.forEach(function (item: LegendItem): void {
                if (item.a11yProxyElement) {
                    ...
                    if (hasPages) {
                        ...
                        const y = item._legendItemPos
                            ? item._legendItemPos[1]
                            : 0;
        ...
        highlightAdjacentLegendPage: function (
            ...
            if (newPageIx > 0 && newPageIx <= pages.length) {
                ...
                for (let i = 0; i < len; ++i) {
                    if (
                        (legend.allItems[i].pageIx as number) + 1 ===
                        newPageIx
                    ) {
        ...
        /**
         * Returns false if legend a11y is disabled and proxies were not
        ...
        getKeyboardNavigation: function (
            ...
            return new (KeyboardNavigationHandler as any)(chart, {
                keyCodeMap: [
                    ...
                    [
                        ...
                        function (
                            ...
                            if (H.isFirefox && keyCode === keys.space) {
                                // #15520
                ...
                terminate: function (): void {
                    ...
                    chart.legend.allItems.forEach((item): unknown =>
                        item.setState('', true)
                    );
                }
            });
        ...
        shouldHaveLegendNavigation: function (
            ...
            const chart = this.chart,
                ...
                legendA11yOptions: DeepPartial<Highcharts.LegendAccessibilityOptions> =
