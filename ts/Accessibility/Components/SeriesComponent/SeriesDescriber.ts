...
namespace SeriesDescriber {
    ...
    export interface AccessibilityPointStateObject {
    ...
    function getPointValue(
        point: SeriesDescriber.PointComposition
    ): string {
        const series = point.series,
     ...
     * @return {string}
     */
    export function defaultPointDescriptionFormatter(
        point: SeriesDescriber.PointComposition
    ): string {
        const series = point.series,
            chart = series.chart,
     ...
     * @return {string}
     */
    export function defaultSeriesDescriptionFormatter(
        series: Accessibility.SeriesComposition
    ): string {
        const chart = series.chart,
