...
let hideSeriesFromAT = ChartUtilities.hideSeriesFromAT;

import SeriesDescriber from './SeriesDescriber.js';
let describeSeries = SeriesDescriber.describeSeries;
 ...
 */
let SeriesComponent: typeof Highcharts.SeriesComponent =
...
extend(SeriesComponent.prototype, /** @lends Highcharts.SeriesComponent */ {
    ...
    onChartRender: function (this: Highcharts.SeriesComponent): void {
        ...
        chart.series.forEach(function (
            ...
            let shouldDescribeSeries = (series.options.accessibility &&
