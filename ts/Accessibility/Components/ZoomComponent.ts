 ...
 */
let ZoomComponent: typeof Highcharts.ZoomComponent = noop as any;
...
extend(ZoomComponent.prototype, /** @lends Highcharts.ZoomComponent */ {
    ...
    onMapNavInit: function (
        ...
        let chart: Highcharts.MapNavigationChart = this.chart as any,
            ...
            keyCodeMap: [
                [
                    ...
                    function (
                        ...
                        let isBackwards = keyCode === keys.tab && e.shiftKey ||
