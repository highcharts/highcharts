 ...
 * @private
 */
function chartHasMapZoom(chart: Highcharts.MapNavigationChart): boolean {
    return !!(
        chart.mapZoom &&
        chart.mapNavButtons &&
...
extend(
    ...
    /** @lends Highcharts.ZoomComponent */ {
        ...
        onMapKbdTab: function (
            ...
            const chart: Highcharts.MapNavigationChart = this
                .chart as Highcharts.MapNavigationChart;
        ...
        /**
         * Get keyboard navigation handler for a simple chart button. Provide
         * the button reference for the chart, and a function to call on click.
         *
         * @private
         * @param {string} buttonProp The property on chart referencing the
         * button.
         * @return {Highcharts.KeyboardNavigationHandler} The module object
         */
        simpleButtonNavigation: function (
            ...
            return new (KeyboardNavigationHandler as any)(chart, {
                keyCodeMap: [
                    ...
                    [
                        [keys.space, keys.enter],
                        function (this: KeyboardNavigationHandler): void {
