...
namespace EditMode {
    export interface Options {
         ...
         * Try it:
         *
         * {@link https://jsfiddle.net/gh/get/library/pure/highcharts/samples/dashboards/edit-mode/ctx-enabled/ | context enabled}
         *
         * @default false
         *
         */
         ...
         * Try it:
         *
         * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/-mode/lang/ | Norwegian language}
         */
         ...
         * Try it:
         *
         * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/-mode/toolbars-disabled}
         */
        toolbars?: Toolbars;
        /**
         * Tools options.
