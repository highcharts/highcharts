...
export interface Options extends Component.Options {
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highcharts/samples/dashboards/demo/datagrid-sync/ | Allow connector update comparison}
     *
     * @default true
     */
    ...
    */
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//sync-extremes/ | Extremes Sync }
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onent-options/sync-highlight/ | Highlight Sync }
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onent-options/sync-visibility/ | Visibility Sync }
     *
     */
    sync?: SyncOptions;
...
export interface ConnectorOptions extends ConnectorHandler.ConnectorOptions {
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onents/highcharts-column-assignment-1d-data | One-dimensional data column assignment}
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onents/highcharts-column-assignment-2d-data | Two-dimensional data column assignment}
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onents/highcharts-column-assignment-keys-data | Key-defined two-dimensional data column assignment}
     *
     * @example
     * ```
...
export interface HighchartsHighlightSyncOptions extends Sync.OptionsEntry {
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//highcharts-highlight-affected-series | Affected Series ID Option }
     *
     * @default null
     */
