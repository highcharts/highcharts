...
export interface Options extends Component.Options {
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highcharts/samples/dashboards/demo/crossfilter | Crossfilter Sync }
     *
...
export interface SyncOptions extends Sync.RawOptionsRecord {
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//crossfilter | Crossfilter Sync }
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onents/crossfilter-affecting-navigators | Crossfilter with affectNavigators enabled }
     *
     * @default false
     */
...
export interface CrossfilterSyncOptions extends Sync.OptionsEntry {
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onents/crossfilter-affecting-navigators | Affect Navigators Enabled }
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main//sync-extremes/ | Affect Navigators Disabled }
     *
     * @default false
     */
