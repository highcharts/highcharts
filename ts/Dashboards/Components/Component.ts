...
namespace Component {
    ...
    * */
    ...
    export interface Options {
         ...
         * Try it:
         *
         * {@link https://jsfiddle.net/gh/get/library/pure/highcharts/samples/dashboards/component-options/events/ | Mount event }
         */
         ...
         * Try it:
         *
         * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onent-options/title/ | Changed captions }
         */
         ...
         * Try it:
         *
         * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onent-options/caption/ | Changed captions }
         */
    ...
    export interface StatesOptions {
        active?: {
             ...
             *
             * Try it:
             * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/onent-options/states/ | Active state }
             *
             * @default false
             */
            isActive?: boolean;
