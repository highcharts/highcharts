...
export interface BoostOptions {
    /**
     * The chart will be boosted, if one of the series crosses its threshold and
     * all the series in the chart can be boosted.
     *
     * @type      {boolean}
     * @default   true
     ...
     * doing the translation in JavaScript.
     *
     * This option may cause rendering issues with certain datasets. Namely,
     * if your dataset has large numbers with small increments (such as
...
declare module '../../Core/Options'{
    interface Options {
         ...
         * types to be rendered by WebGL instead of the default SVG. This allows
         * hundreds of thousands of data points to be rendered in milliseconds.
         * In addition to the WebGL rendering it saves time by skipping
         * processing and inspection of the data wherever possible. This
         * introduces some limitations to what features are available in boost
         * mode. See [the docs](https://www.highcharts.com/docs/advanced-chart-features/boost-module)
         * for details.
         *
         * In addition to the global `boost` option, each series has a
         * [boostThreshold](#plotOptions.series.boostThreshold) that defines
         * when the boost should kick in.
         *
...
declare module '../../Core/Series/SeriesOptions' {
    interface SeriesOptions {
         ...
         *
         * Note that the [cropThreshold](plotOptions.series.cropThreshold) also
         * affects this setting. When zooming in on a series that has fewer
         * points than the `cropThreshold`, all points are rendered although
