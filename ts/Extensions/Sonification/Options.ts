 ...
 * @requires modules/sonification
 */
export interface SeriesEventContext {
    /**
     * The relevant series.
     */
    series?: Series,
...
export interface BoundaryHitContext {
    chart?: Chart,
    timeline: SonificationTimeline,
 ...
 * @requires modules/sonification
 */
export type SeriesCallback = (s: SeriesEventContext) => void;
/**
 * Callback function for sonification events on chart.
 *
 * @requires modules/sonification
 */
export type ChartCallback = (c: ChartEventContext) => void;
export type BoundaryHitCallback = (e: BoundaryHitContext) => void;
export type TrackValueCallback = (context: TimelineEventContext) => number;
export type TrackStringCallback = (context: TimelineEventContext) => string;
export type TrackPredicateCallback =
    (context: TimelineEventContext) => boolean;
export type TrackOptions = Array<InstrumentTrackOptions|SpeechTrackOptions>;
export type InstrumentContextTrackOptions = InstrumentTrackOptions &
ContextOptions;
export type SpeechContextTrackOptions = SpeechTrackOptions & ContextOptions;
export type ContextTrackOptions = Array<InstrumentContextTrackOptions|SpeechContextTrackOptions>;
export type MapFunctionTypes = 'linear'|'logarithmic';
export type PointGroupingAlgorithmTypes = 'minmax'|'first'|'last'|
'middle'|'firstlast';
export type MappingParameter =
string|number|TrackValueCallback|MappingParameterOptions;

export interface MappingParameterOptions {
    /**
...
export interface PitchMappingParameterOptions extends Omit<MappingParameterOptions, 'min'|'max'> {
    /**
...
export interface FilterMappingOptions {
    /**
...
export interface TremoloMappingOptions {
    /**
...
export interface PointGroupingOptions {
    /**
...
export interface InstrumentTrackMappingOptions {
    /**
...
export interface InstrumentTrackOptions extends BaseTrackOptions {
    /**
...
export interface SpeechTrackMappingOptions {
    /**
...
export interface SpeechTrackOptions extends BaseTrackOptions {
    /**
