...
//       making changes here.
let defaultInstrumentOptions: Highcharts.PointInstrumentOptionsObject = {
    minDuration: 20,
    maxDuration: 2000,
    minVolume: 0.1,
    maxVolume: 1,
...
function pointSonify(
    ...
    let signalHandler = point.sonification.signalHandler =
    ...
    options.instruments.forEach(function (
        ...
        let instrument = typeof instrumentDefinition.instrument === 'string' ?
...
function pointCancelSonify(
    ...
    let playing = this.sonification && this.sonification.instrumentsPlaying,
...
let pointSonifyFunctions: Highcharts.PointSonifyFunctions = {
    pointSonify,
    pointCancelSonify
};
