...
// DO NOT EDIT!
// Automatically generated by ./tools/gulptasks/scripts-messages.js
...
const errorMessages: Record<string, Record<string, string>> = {
    ...
    "33": {
        "title": "Invalid attribute, tagName or CSS",
        "text": "<h1>Invalid attribute, tagName or CSS</h1><p>This error occurs if HTML in the chart configuration contains unknown tag names or attributes, or CSS that loads an external resource. Unknown tag names or attributes are those not present in the _allow lists_.</p><p>To fix the error, consider</p><ul><li>Is your tag name or attribute spelled correctly? For example, <code>lineargradient</code></li></ul><p> would be blocked as it is a misspelling for <code>linearGradient</code>.</p><ul><li>Is it allowed in Highcharts? For example, <code>onclick</code> attributes are blocked as</li></ul><p> they pose a real security threat.</p><ul><li>Does a style load an external resource? An external <code>url()</code> is blocked.</li></ul><p>This error occurs because attributes, tag names and styles are sanitized of potentially harmful content from the chart configuration before being added to the DOM. Consult the <a href=\"https://www.highcharts.com/docs/chart-concepts/security\">security documentation</a> for more information.</p>"
    },
    "34": {
