...
const errorMessages: Record<string, Record<string, string>> = {
    ...
    "21": {
        ...
        "text": "<h1>Can't find Proj4js library</h1><p>Using latitude/longitude functionality with pre-projected GeoJSON in Highcharts Maps requires the <a href=\http://proj4js.org\">Proj4js</a> library to be loaded.</p></br><p>It is recommended to utilize TopoJSON for Highcharts v10 and above, as built-in projection support is included and no third-party library is required. For more information, see the <a href=\"https://www.highcharts.com/blog/tutorials/highcharts-now-prefers-topojson-maps\">Highcharts now prefers topojson maps</a></p>"
    },
    "22": {
