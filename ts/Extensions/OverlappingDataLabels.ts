...
addEvent(Chart, 'render', function collectAndHide(): void {
    ...
    (this.yAxis || []).forEach(function (yAxis): void {
        if (
            ...
            objectEach(
                ...
                function (stack: Record<string, Highcharts.StackItem>): void {
                    objectEach(
                        stack,
                        function (stackItem: Highcharts.StackItem): void {
                            if (
                                stackItem.label &&
    ...
    (this.series || []).forEach(function (series): void {
        const dlOptions: DataLabelOptions = series.options.dataLabels as any;
            ...
            const push = (points: Point[]): void =>
                points.forEach((point: Point): void => {
                    if (point.visible) {
                        ...
                        dataLabels.forEach(function (label: SVGElement): void {
...
Chart.prototype.hideOverlappingLabels = function (
    ...
    let chart = this,
        ...
        getAbsoluteBox = function (label: SVGElement): BBoxObject | undefined {
            ...
            if (label && (!label.alignAttr || label.placed)) {
                ...
                if (!label.width) {
                    ...
                    lineHeightCorrection = ren.fontMetrics(
                        null as any,
                        label.element
                    ).h;
                }
    ...
    labels.sort(function (a: SVGElement, b: SVGElement): number {
