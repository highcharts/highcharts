...
Point.prototype.calculatePatternDimensions = function (
    ...
    let bBox: Highcharts.BPatternObject = this.graphic && (
...
wrap(Series.prototype, 'getColor', function (
    ...
    let oldColor = this.options.color;
