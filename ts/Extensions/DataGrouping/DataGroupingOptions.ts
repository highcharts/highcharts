...
declare module '../../Core/Series/SeriesOptions' {
    interface SeriesOptions {
         ...
         * JavaScript charts. Highcharts Stock by default applies data grouping
         * when the points become closer than a certain pixel value, determined
         * by the `groupPixelWidth` option.
         *
         * If data grouping is applied, the grouping information of grouped
         * points can be read from the [Point.dataGroup](
         * /class-reference/Highcharts.Point#dataGroup). If point options other
...
export interface DataGroupingOptions {
    /**
     * Specifies how the points should be located on the X axis inside the
     * group. Points that are extremes can be set separately. Available options:
     *
     ...
     * "low", "close" and "sum". For OHLC and candlestick series the
     ...
     * [Series.getExtremesFromAll](#plotOptions.series.getExtremesFromAll)
