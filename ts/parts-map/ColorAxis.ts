...
class ColorAxis extends Axis implements AxisLike {
    ...
    public init(
        ...
        const options = ColorAxis.buildOptions.call( // Build the options
            this,
            chart,
            userOptions
        );
    ...
    public update(
        ...
        const axis = this,
            chart = axis.chart,
            legend = chart.legend,
            updatedOptions = ColorAxis.buildOptions.call(this, chart, newOptions);
    ...
    // TODO: fix TS
    public renderAsLegendItem(this: any): void {
        if (!this.legendGroup) {
