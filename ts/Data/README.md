...
With DataPool one can "lazy" load stores besides the initial phase. After
adding store name, store type and store options to DataPool, one can request
...
DataPool is one of possible way to coordinate and share stores and their
