...
export interface JSONConnectorOptions extends DataConnectorOptions {
    ...
    /**
     * URL to the JSON data. try it {@link https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/data-tools/datapool-json-connector-dataurl/ | data fetched from url }
     */
    dataUrl?: string;
     ...
     * Try it:
     *
     * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/-tools/datapool-json-connector-orientation/ | JSON Connector orientation }
     *
     * @default 'rows'
     */
 ...
 *
 * {@link https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/-tools/datapool-json-connector-enable-polling/ | JSON Connector with beforeParse and enablePolling }
 */
