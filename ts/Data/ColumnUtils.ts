...
import type { DataTableCellType, DataTableColumn } from './DataTableTypes';
 ...
 */
export interface ColumnUtilsShiftResult {
 ...
 */
export interface ColumnUtilsSpliceResult<T extends DataTableColumn> {
    removed: T
    array: T
}
...
): ColumnUtilsSpliceResult<DataTableColumn> {
    if (Array.isArray(column)) {
...
namespace ColumnUtils {
    /** @deprecated */
    export type ShiftResult = ColumnUtilsShiftResult;
    /** @deprecated */
    export type SpliceResult<T extends DataTableColumn> = ColumnUtilsSpliceResult<T>;
}
