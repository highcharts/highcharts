...
declare global {
	namespace Highcharts {
		...
		class DumbbellSeries extends AreaRangeSeries {
			...
			public pointAttribs(point: DumbbellPoint, state: string): SVGAttributes;
		}
	}
}
...
seriesType<Highcharts.DumbbellSeriesOptions>('dumbbell', 'arearange', {
	 ...
	 * @return {Object} The path and styles.
	 */
	...
	drawConnector: function(
		...
		var series = this,
			...
			verb = series.chart.pointCount < animationLimit ? 'animate' : 'attr';
