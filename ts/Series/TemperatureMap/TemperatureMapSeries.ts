 ...
 */
class TemperatureMapSeries extends BubbleSeries {
     ...
     */
    public static defaultOptions: TemperatureMapSeriesOptions = merge(BubbleSeries.defaultOptions, {
    ...
    } as TemperatureMapSeriesOptions);
