...
class CylinderSeries extends ColumnSeries {
     ...
     */
    public static defaultOptions: Highcharts.CylinderSeriesOptions = merge(ColumnSeries.defaultOptions);
    ...
    public options: Highcharts.CylinderSeriesOptions = void 0 as any;
...
class CylinderPoint extends ColumnSeries.prototype.pointClass {
    ...
    public options: Highcharts.CylinderPointOptions = void 0 as any;
