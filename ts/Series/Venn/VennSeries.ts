...
class VennSeries extends ScatterSeries {
        ...
        let best = internal.reduce(function (
            ...
            return [
                ...
                .reduce(function (
                    ...
                    let margin = VennUtils.getMarginFromCircles(point, internal, external);
    ...
    public static getScale(
        ...
        let height = field.bottom - field.top, // top is smaller than bottom
    ...
    public translate(): void {
        ...
        let relations = VennUtils.processVennData(this.options.data as any);

        // Calculate the positions of each circle.
        const { mapOfIdToShape, mapOfIdToLabelValues } = VennSeries.layout(relations);

        // Calculate the scale, and center of the plot area.
        let field = Object.keys(mapOfIdToShape)
                .filter(function (key: string): boolean {
                    let shape = mapOfIdToShape[key];
