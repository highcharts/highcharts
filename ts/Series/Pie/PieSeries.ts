...
class PieSeries extends Series {
    ...
    public static defaultOptions: PieSeriesOptions = merge(
        Series.defaultOptions,
        {
             ...
             * clicked. One parameter, event, is passed to the function. The
             * state of the checkbox is found by event.checked. The checked item
             * is found by event.item. Return false to prevent the default
             * action which is to toggle the select state of the series.
             *
             * @sample {highcharts}
             *         highcharts/plotoptions/series-events-checkboxclick/ Alert
             *         checkbox status
             *
             * @type      {Function}
             * @since     1.2.0
             ...
             * event information. The default action is to toggle the visibility
             * of the point. This can be prevented by calling
             * `event.preventDefault()`.
             *
             * @sample {highcharts}
             *         highcharts/plotoptions/pie-point-events-legenditemclick/
             ...
             * percentages or pixel values. The default behaviour (as of 3.0) is
             * to center the pie so that all slices and data labels are within
             * the plot area. As a consequence, the pie may actually jump around
             * in a chart with dynamic values, as the data labels move. In that
             * case, the center should be explicitly set, for example to
             * `["50%", "50%"]`.
             *
            ...
            /**
             * The color of the pie series. A pie series is represented as an
             * empty circle if the total sum of its values is 0. Use this
             * property to define the color of its border.
             *
             * In styled mode, the color can be defined by the
             * [colorIndex](#plotOptions.series.colorIndex) option. Also, the
            ...
            /**
             * A series specific or series type specific color set to use
             * instead of the global [colors](#colors).
             *
             * @sample {highcharts} highcharts/demo/pie-monochrome/ Set default
             *         colors for all pies
             *
            ...
            dataLabels: {
                 ...
                 *
                 * - `toPlotEdges`: Each label touches the nearest vertical edge
                 *   of the plot area.
                 *
                 * - `connectors`: Connectors have the same x position and the
                 *   widest label of each half (left & right) touches the
                 *   nearest vertical edge of the plot area.
                 *
                 * @sample {highcharts}
                 *         highcharts/plotoptions/pie-datalabels-alignto-connectors/
                 *         alignTo: connectors
                 * @sample {highcharts}
                 *         highcharts/plotoptions/pie-datalabels-alignto-plotedges/
                 *         alignTo: plotEdges
                 *
                 * @type      {string}
                 * @since     7.0.0
                ...
                /**
                 * The color of the line connecting the data label to the pie
                 ...
                 *         Blue connectors
                 * @sample {highcharts} highcharts/css/pie-point/ Styled
                 *         connectors
                 *
                 * @type      {Highcharts.ColorType}
                 * @since     2.1
                 ...
                 * data labels also have a default `padding`, so in order for
                 * the connector to touch the text, the `padding` must also be
                 * 0.
                 *
                 * @sample {highcharts}
                ...
                /**
                 * Specifies the method that is used to generate the connector
                 * path. Highcharts provides 3 built-in connector shapes:
                 * `'fixedOffset'` (default), `'straight'` and `'crookedLine'`.
                 * Using `'crookedLine'` has the most sense (in most of the
                 * cases) when `'alignTo'` is set.
                 *
                 * Users can provide their own method by passing a function
                 * instead of a String. 3 arguments are passed to the callback:
                 *
                 * - Object that holds the information about the coordinates of
                 *   the label (`x` & `y` properties) and how the label is
                 *   located in relation to the pie (`alignment` property).
                 *   `alignment` can by one of the following: `'left'` (pie on
                 *   the left side of the data label), `'right'` (pie on the
                 *   right side of the data label) or `'center'` (data label
                 *   overlaps the pie).
                 *
                 * - Object that holds the information about the position of the
                 *   connector. Its `touchingSliceAt`  porperty tells the
                 *   position of the place where the connector touches the
                 *   slice.
                 *
                 * - Data label options
                 *
                 * The function has to return an SVG path definition in array
                ...
                /**
                 * Works only if `connectorShape` is `'crookedLine'`. It defines
                 * how far from the vertical plot edge the coonnector path
                 * should be crooked.
                 *
                 * @sample {highcharts}
                 *         highcharts/plotoptions/pie-datalabels-crookdistance/
                 ...
                 * numbers put the data label on top of the pie slices. Can also
                 * be defined as a percentage of pie's radius. Connectors are
                 * only shown for data labels outside the pie.
                 *
                 * @sample {highcharts}
                 *         highcharts/plotoptions/pie-datalabels-distance/ Data
                 *         labels on top of the pie
                 *
                 * @type    {number|string}
                 * @since   2.1
                 * @product highcharts
                ...
                /**
                 * Callback JavaScript function to format the data label. Note
                 * that if a `format` is defined, the format takes precedence
                 * and the formatter is ignored.
                 *
                 * @type {Highcharts.DataLabelsFormatterCallbackFunction}
                 * @default function () { return this.point.isNull ? void 0 :
                 * this.point.name; }
                 */
                formatter: function (
            ...
            /**
             * If the total sum of the pie's values is 0, the series is
             * represented as an empty circle . The `fillColor` option defines
             * the color of that circle. Use
             * [pie.borderWidth](#plotOptions.pie.borderWidth) to set the border
             * thickness.
             *
             * @sample {highcharts} highcharts/plotoptions/pie-emptyseries/
             *         Empty pie series
            ...
            /**
             * The end angle of the pie in degrees where 0 is top and 90 is
             * right. Defaults to `startAngle` plus 360.
             *
             * @sample {highcharts} highcharts/demo/pie-semi-circle/ Semi-circle
             *         donut
             *
             * @type      {number}
             * @since     1.3.6
             ...
             * Percentages are relative to the pie size. Pixel values are given
             * as integers.
             *
             *
             * Note: in Highcharts < 4.1.2, the percentage was relative to the
             * plot area, not the pie size.
             *
             * @sample {highcharts} highcharts/plotoptions/pie-innersize-80px/
             *         80px inner size
             * @sample {highcharts}
             *         highcharts/plotoptions/pie-innersize-50percent/ 50% of
             *         the plot area
            ...
            /**
             * The minimum size for a pie in response to auto margins. The pie
             * will try to shrink to make room for data labels in side the plot
             ...
             * percentage or pixel value. Pixel values are given as integers.
             * The default behaviour (as of 3.0) is to scale to the plot area
             * and give room for data labels within the plot area.
             * [slicedOffset](#plotOptions.pie.slicedOffset) is also included in
             * the default size calculation. As a consequence, the size of the
             * pie may vary when points are updated and data labels more around.
             * In that case it is best to set a fixed value, for example
             * `"75%"`.
             *
            ...
            /**
             * The start angle of the pie slices in degrees where 0 is top and
             * 90 right.
             *
             ...
             * the series'  graph or markers. This also implies the tooltip.
             * When `stickyTracking` is false and `tooltip.shared` is false, the
             ...
             *
             * @sample {highcharts}
             *         highcharts/plotoptions/pie-bordercolor-black/ Black
             *         border
             *
             * @type    {Highcharts.ColorType}
             * @default #ffffff
             ...
             *
             * When setting the border width to 0, there may be small gaps
             * between the slices due to SVG antialiasing artefacts. To work
             * around this, keep the border width at 0.5 or 1, but set the
             * `borderColor` to `null` instead.
             *
             * In styled mode, the border stroke width is given in the
             * `.highcharts-point` class.
             *
             * @sample {highcharts} highcharts/plotoptions/pie-borderwidth/ 3px
             *         border
             *
             * @product highcharts
             *
            ...
            states: {
                ...
                hover: {
                     ...
                     *
                     * In styled mode, the hover brightness is by default
                     * replaced by a fill-opacity given in the
                     * `.highcharts-point-hover` class.
                     *
                     * @sample {highcharts}
        ...
        this.points.forEach(function (point): void {
            ...
            if (!point.graphic) {
                point.graphic = (renderer as any)
                    [point.shapeType as any](point.shapeArgs)
    ...
    public translate(positions?: Array<number>): void {
        ...
        for (i = 0; i < len; i++) {
            ...
            point.slicedTranslation = {
                translateX: Math.round(Math.cos(angle) * (slicedOffset as any)),
                translateY: Math.round(Math.sin(angle) * (slicedOffset as any))
            };
