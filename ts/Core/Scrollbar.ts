...
class Scrollbar {
     ...
     */
    public static swapXY(path: SVGPath, vertical?: boolean): SVGPath {
        if (vertical) {
    ...
    public _events: Array<[any, string, Scrollbar.EventCallback]> = [];
    ...
    public addEvents(): void {
        ...
        // Mouse events
        const _events: Array<[any, string, (e: PointerEvent) => void]> = [
            [
