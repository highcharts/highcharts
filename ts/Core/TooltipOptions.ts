...
export interface TooltipOptions {
     ...
     * ordered data, as well as scatter and bubble, will be shown in a single
     * bubble. Series types that have no shared X value, like pie and flags,
     * show only the hovered point. This is recommended for single series
     * charts and for tablet/mobile optimized charts.
     *
