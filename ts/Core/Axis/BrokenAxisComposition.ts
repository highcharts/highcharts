...
export declare class BrokenAxisComposition extends Axis {
    /**
...
function onAxisInit(this: Axis): void {
    ...
    if (!axis.brokenAxis) {
        axis.brokenAxis = new BrokenAxisAdditions(
            axis as BrokenAxisComposition
        );
    }
}
...
/**
 * Provides support for broken data rows.
 * @private
 * @class
 */
class BrokenAxisAdditions {
    ...
    public static compose<T extends typeof Axis>(
    ...
    ): (T&typeof BrokenAxisComposition) {
        ...
        return AxisClass as (T&typeof BrokenAxisComposition);
    }
    ...
    public constructor(axis: BrokenAxisComposition) {
        this.axis = axis;
    }
    ...
    public axis: BrokenAxisComposition;
...
export default BrokenAxisAdditions;
