...
export interface ScrollbarAxisComposition extends Axis {
    scrollbar?: ScrollbarType;
}
...
function onAxisAfterGetOffset(
    ...
    const axis = this as ScrollbarAxisComposition,
...
const ScrollbarAxisComposition = {
    compose
};

export default ScrollbarAxisComposition;
