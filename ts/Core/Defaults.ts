...
const defaultOptions: DefaultOptions = {
     ...
     * [custom legend symbols](https://highcharts.com/samples/highcharts/studies/legend-custom-symbol/).
     *
    ...
    legend: {
         ...
         * export](https://highcharts.com/samples/highcharts/legend/navigation-enabled-false/).
         *
