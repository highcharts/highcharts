...
const seriesDefaults: PlotOptionsOf<Series> = {
     ...
     *
     * In styled mode, the
     * [stroke dash-array](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/css/series-dashstyle/)
     ...
     * option
     * ([view live demo](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/color-zones/)).
     *
