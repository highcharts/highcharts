...
import type R from '../Renderer/RendererUtilities';
...
class Series {
    ...
    public _hasPointLabels?: boolean;
    ...
    public alignDataLabel(
            ...
            visible =
                ...
                (
                    ...
                    (
                        ...
                        // enough that parts of the align box is inside the plot
                        // area (#12370). When stacking, it is always inside
                        // regardless of the option (#15148).
        ...
        const setStartPos = (alignOptions: AlignObject): void => {
    ...
    public drawDataLabels(): void {
         ...
         * other is merged into each element. If both are arrays, each element
         * is merged by index. If neither are arrays, we use normal merge.
         * @private
         */
    ...
    public setDataLabelStartPos(
        ...
        const chart = this.chart,
            ...
            pointWidth = (point as ColumnPoint).pointWidth,
