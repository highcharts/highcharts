    ...
    function onAfterDrawChartBox(this: Chart): void {
        if (
            ...
            this.frameShapes.bottom[verb]({
                ...
                faces: [{ // bottom
                    fill: Color.parse(frame.bottom.color).brighten(0.1).get(),
                    vertexes: [{
                        x: xmm,
                        y: ypp,
                        z: zmm
                ...
                { // front
                    fill: Color.parse(frame.bottom.color).get(),
                    vertexes: [{
                        x: xpp,
                        y: ypp,
                        z: zmm
            ...
            this.frameShapes.top[verb]({
                ...
                faces: [{ // bottom
                    fill: Color.parse(frame.top.color).brighten(0.1).get(),
                    vertexes: [{
                        x: xmm,
                        y: ymm,
                        z: zpp
                ...
                { // front
                    fill: Color.parse(frame.top.color).get(),
                    vertexes: [{
                        x: xmm,
                        y: ymm,
                        z: zmm
            ...
            this.frameShapes.left[verb]({
                ...
                faces: [{ // bottom
                    fill: Color.parse(frame.left.color).brighten(0.1).get(),
                    vertexes: [{
                        x: xmm,
                        y: ypp,
                        z: zmm
                ...
                { // front
                    fill: Color.parse(frame.left.color).get(),
                    vertexes: [{
                        x: xmm,
                        y: ypp,
                        z: zmm
            ...
            this.frameShapes.right[verb]({
                ...
                faces: [{ // bottom
                    fill: Color.parse(frame.right.color).brighten(0.1).get(),
                    vertexes: [{
                        x: xpp,
                        y: ypp,
                        z: zpp
                ...
                { // front
                    fill: Color.parse(frame.right.color).get(),
                    vertexes: [{
                        x: xpp,
                        y: ymm,
                        z: zmm
            ...
            this.frameShapes.back[verb]({
                ...
                faces: [{ // bottom
                    fill: Color.parse(frame.back.color).brighten(0.1).get(),
                    vertexes: [{
                        x: xpp,
                        y: ypp,
                        z: zpp
                ...
                { // front
                    fill: Color.parse(frame.back.color).get(),
                    vertexes: [{
                        x: xm,
                        y: ym,
                        z: zp
            ...
            this.frameShapes.front[verb]({
                ...
                faces: [{ // bottom
                    fill: Color.parse(frame.front.color).brighten(0.1).get(),
                    vertexes: [{
                        x: xmm,
                        y: ypp,
                        z: zmm
                ...
                { // front
                    fill: Color.parse(frame.front.color).get(),
                    vertexes: [{
                        x: xp,
                        y: ym,
                        z: zm
