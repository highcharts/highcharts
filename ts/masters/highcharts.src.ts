...
// Utilities
G.addEvent = addEvent;
G.arrayMax = AH.arrayMax;
G.arrayMin = AH.arrayMin;
...
G.css = Utilities.css;
G.defined = OH.defined;
G.destroyObjectProperties = OH.destroyObjectProperties;
