...
// Utilities
G.addEvent = addEvent;
G.arrayMax = ArrayHelper.arrayMax;
G.arrayMin = ArrayHelper.arrayMin;
...
G.css = Utilities.css;
G.defined = ObjectHelper.defined;
G.destroyObjectProperties = ObjectHelper.destroyObjectProperties;
G.discardElement = Utilities.discardElement;
G.distribute = RendererUtilities.distribute;
G.erase = ArrayHelper.erase;
G.error = Utilities.error;
G.extend = ObjectHelper.extend;
G.extendClass = Utilities.extendClass;
G.find = ArrayHelper.find;
G.fireEvent = fireEvent;
G.getMagnitude = Utilities.getMagnitude;
G.getStyle = Utilities.getStyle;
G.inArray = ArrayHelper.inArray;
G.isArray = TypeChecker.isArray;
G.isClass = TypeChecker.isClass;
G.isDOMElement = TypeChecker.isDOMElement;
G.isFunction = TypeChecker.isFunction;
G.isNumber = TypeChecker.isNumber;
G.isObject = TypeChecker.isObject;
G.isString = TypeChecker.isString;
G.keys = Utilities.keys;
G.merge = ObjectHelper.merge;
G.normalizeTickInterval = Utilities.normalizeTickInterval;
G.objectEach = ObjectHelper.objectEach;
...
G.splat = ArrayHelper.splat;
G.stableSort = ArrayHelper.stableSort;
