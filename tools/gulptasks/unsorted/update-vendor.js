...
function updateVendor() {
    const { copyFile } = require('../../filesystem.js');
    ...
    const promises = [
        ...
        ['./node_modules/jspdf-yworks/dist/jspdf.min.js', './vendor/jspdf.js'],
        [
            './node_modules/svg2pdf.js/dist/svg2pdf.js',
            './vendor/svg2pdf.src.js'
        ],
        ['./node_modules/svg2pdf.js/dist/svg2pdf.min.js', './vendor/svg2pdf.js']
