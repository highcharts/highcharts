...
functions.
[View live demo](https://jsfiddle.net/gh/get/library/pure/highcharts/samples/highcharts/yaxis/type-log-negative/).
It is also possible to use a similar workaround for colorAxis.
[View live demo](https://jsfiddle.net/gh/get/library/pure/highchartshighcharts/tree/main/raxis/logarithmic-with-emulate-negative-values/).
